...
$page_title = "Stud Welding Machine";
...
// Override category name for Stud Welding subcategory page
if ($current_category && $subcategory_id === 'stud-welding-machine') {
    $current_category['name'] = 'Stud Welding Machine';
    $current_category['description'] = 'Professional stud welding machines for industrial applications.';
}
...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Professional stud welding machines for industrial applications.',
        'subcategories' => array(
            array('id' => 'stud-welding-machine', 'name' => 'Stud Welding Machine')
        )
    );
}
?>
...
<body>
    ...
    <aside id="sidebar" class="sidebar-overlay" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Stud Welding Machine'); ?></h2>
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch Stud Welding machine products
                $all_products = andison_get_products_for_subcategory('arc-welding-machine', 'stud-welding-machine');
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h4>Stud Welding Machine</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="Stud Welding Machine" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
