...
$subcategory_id = "stud-welding-machine";
...
if (!$current_category) {
    die("Stud Welding Machine category not found");
}

$page_title = $current_category['name'] ?? "Stud Welding Machine";
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Stud Welding Machine';
    $category_description = $current_category['description'] ?? 'Professional stud welding machines for industrial applications.';
    ?>
        ...
        <div class="category-content">
            ...
            <div class="product-grid">
                ...
                <div class="product-card">
                    ...
                    <h4>Stud Welding Equipment</h4>
                    <p class="product-type">No products available</p>
                    <button class="add-to-inquiry" type="button" data-model="Stud Welding Machine" data-type="Welding Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
