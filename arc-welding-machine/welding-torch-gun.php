...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'High-quality welding torch guns for industrial welding applications.',
        'subcategories' => array(
...
<head>
    ...
    $category_description = 'High-quality welding torch guns for industrial welding applications.';
    ?>
...
<body>
    ...
    <div class="category-content">
        ...
        <div class="main-product-area">
            ...
            <?php 
            $all_products = andison_get_products_for_subcategory('arc-welding-machine', 'welding-torch-gun');
