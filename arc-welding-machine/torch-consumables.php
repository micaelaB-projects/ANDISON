...
$page_title = "Torch Consumables";
$category_id = "arc-welding-machine";
$subcategory_id = "torch-consumables";
...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Torch Consumables',
        'description' => 'High-quality torch consumables for welding and cutting applications.',
        'subcategories' => array(
            array('id' => 'torch-consumables', 'name' => 'Torch Consumables')
        )
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = 'Torch Consumables';
    $category_description = 'High-quality torch consumables for welding and cutting applications.';
    ?>
...
<body>
    ...
    <div class="category-content">
        ...
        <div class="main-product-area">
            ...
            <?php 
            $all_products = andison_get_products_for_subcategory('arc-welding-machine', 'torch-consumables');
