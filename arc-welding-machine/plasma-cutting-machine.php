...
$page_title = "Plasma Cutting Machine";
...
// Override category name for Plasma Cutting subcategory page
if ($current_category && $subcategory_id === 'plasma-cutting-machine') {
    $current_category['name'] = 'Plasma Cutting Machine';
    $current_category['description'] = 'High-precision plasma cutting machines for industrial applications.';
}
...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'High-precision plasma cutting machines for industrial applications.',
        'subcategories' => array(
            array('id' => 'plasma-cutting-machine', 'name' => 'Plasma Cutting Machine')
        )
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'High-precision plasma cutting machines for industrial applications.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch Plasma Cutting machine products
                $all_products = andison_get_products_for_subcategory('arc-welding-machine', 'plasma-cutting-machine');
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Plasma Cutting Machine" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
