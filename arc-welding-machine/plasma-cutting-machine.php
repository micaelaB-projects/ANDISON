...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'High-performance plasma cutting machines for industrial applications.',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Plasma Cutting Machine';
    $category_description = 'High-performance plasma cutting machines for industrial applications.';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Plasma Cutting Machine products
