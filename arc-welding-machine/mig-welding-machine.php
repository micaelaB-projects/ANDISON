...
<head>
    ...
    <?php 
    $category_name = 'MIG Welding Machine';
    $category_description = 'High-performance MIG welding machines for industrial applications.';
    ?>
    ...
    <!-- Overlay Backdrop --><?php include $_SERVER['DOCUMENT_ROOT'] . '/ANDISON/includes/sidebar.php'; ?>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only MIG Welding Machine products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h4>MIG Welding Machine</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="MIG Welding Machine" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
