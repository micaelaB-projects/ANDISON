        ...
        <div class="category-content">
            ...
            <div class="product-grid">
                ...
                <div class="product-card">
                    ...
                    <h4>MIG Welding Equipment</h4>
                    <p class="product-type">No products available</p>
                    <button class="add-to-inquiry" type="button" data-model="MIG Welding Machine" data-type="Welding Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
