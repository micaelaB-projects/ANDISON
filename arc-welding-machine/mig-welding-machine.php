...
$page_title = "MIG Welding Machine";
...
// Override category name for MIG subcategory page
if ($current_category && $subcategory_id === 'mig-welding-machine') {
    $current_category['name'] = 'MIG Welding Machine';
    $current_category['description'] = 'High-performance MIG welding machines for industrial applications.';
}
...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'High-performance MIG welding machines for industrial applications.',
        'subcategories' => array(
            array('id' => 'mig-welding-machine', 'name' => 'MIG Welding Machine')
        )
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'High-performance MIG welding machines for industrial applications.';
    ?>
...
<body>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'MIG Welding Machine'); ?></h2>
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch MIG welding machine products only
                $all_products = andison_get_products_for_subcategory('arc-welding-machine', 'mig-welding-machine');
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h4>MIG Welding Machines</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="MIG Welding Machines" data-type="Equipment" data-brand="Panasonic Connect" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
