...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'High-performance TIG welding machines for industrial applications.',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'TIG Welding Machine';
    $category_description = 'High-performance TIG welding machines for industrial applications.';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only TIG Welding Machine products
