...
$page_title = "TIG Welding Machine";
...
// Override category data for TIG welding machine subcategory
if ($current_category && $subcategory_id === 'tig-welding-machine') {
    $current_category['name'] = 'TIG Welding Machine';
    $current_category['description'] = 'High-quality TIG welding machines for precision welding applications.';
}
...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'High-quality TIG welding machines for precision welding applications.',
        'subcategories' => array(
            array('id' => 'tig-welding-machine', 'name' => 'TIG Welding Machine')
        )
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'High-quality TIG welding machines for precision welding applications.';
    ?>
...
<body>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'TIG Welding Machine'); ?></h2>
            ...
            <div class="main-product-area">
                ...
                // Fetch products for TIG welding machine subcategory
                $all_products = andison_get_products_for_subcategory('arc-welding-machine', 'tig-welding-machine');
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h4>TIG Welding Machine</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="TIG Welding Machine" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
