...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'subcategories' => array(
            array('id' => 'arc-welding-machine', 'name' => 'Arc Welding Machine')
        )
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = 'Arc Welding Machine';
    $category_description = 'Discover our comprehensive range of arc welding machines for industrial applications.';
    ?>
