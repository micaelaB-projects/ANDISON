...
$page_title = "Accessories & Consumables";
...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Discover our complete range of welding accessories and consumables for optimal performance.',
        'subcategories' => array(
            array('id' => 'accessories-and-consumables', 'name' => 'Accessories & Consumables')
        )
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = 'Accessories & Consumables';
    $category_description = 'Discover our complete range of welding accessories and consumables for optimal performance';
    ?>
...
<body>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch accessories and consumables products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Accessories & Consumables" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
    ...
    <script>
        ...
        // ============================================
        var pageConfig = {
            categoryId: '<?php echo htmlspecialchars($category_id); ?>',
            subcategoryId: '<?php echo htmlspecialchars($subcategory_id); ?>',
            categoryName: '<?php echo htmlspecialchars($category_name); ?>'
        };
