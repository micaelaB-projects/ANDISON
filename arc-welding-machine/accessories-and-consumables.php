...
$subcategory_id = "accessories-and-consumables";
...
if (!$current_category) {
    die("Accessories & Consumables category not found");
}

$page_title = $current_category['name'] ?? "Accessories & Consumables";
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Accessories & Consumables';
    $category_description = $current_category['description'] ?? 'Professional welding accessories and consumables for all arc welding applications.';
    ?>
...
<body>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Accessories & Consumables'); ?></h2>
            ...
            <div class="product-grid">
                <?php 
                // Dynamically fetch products for Accessories & Consumables subcategory
                $all_products = array();
                ...
                <div class="product-card">
                    ...
                    <button class="add-to-inquiry" type="button" data-model="Accessories & Consumables" data-type="Welding Equipment" data-brand="Industrial">ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
