...
$page_title = "Accessories and Consumables";
...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Discover our comprehensive range of welding accessories and consumables for arc welding applications.',
        'subcategories' => array(
            array('id' => 'accessories-and-consumables', 'name' => 'Accessories and Consumables')
        )
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = 'Accessories and Consumables';
    $category_description = 'Discover our comprehensive range of welding accessories and consumables for arc welding applications.';
    ?>
...
<body>
    ...
    <!-- Overlay Backdrop --><?php include $_SERVER['DOCUMENT_ROOT'] . '/ANDISON/includes/sidebar.php'; ?>
        ...
        <div class="category-content">
            <h2>Accessories and Consumables</h2>
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Accessories and Consumables products
                $all_products = andison_get_products_for_subcategory('arc-welding-machine', 'accessories-and-consumables');
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h4>Accessories and Consumables</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="Accessories and Consumables" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
