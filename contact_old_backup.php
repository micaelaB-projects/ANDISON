...
<head>
    ...
    <style>
        * {
        ...
        /* Adjust main container for mini sidebar ΓÇö collapsed by default on desktop */
        section,
        footer,
        .page-content,
        .main-content, 
        ...
        /* Mini popover ΓÇö mobile overrides */
        @media (max-width: 768px) {
            .mini-popover {
...
<body>
    ...
    <aside id="sidebar" class="sidebar-overlay" aria-hidden="true">
        <div style="padding: 14px 20px; background: linear-gradient(135deg, #00D7B3 0%, #00D7B3 100%); display: flex; align-items: center; justify-content: space-between; gap: 12px;">
            ...
            <button id="closeSidebar" style="background: transparent; border: none; color: white; cursor: pointer; font-size: 24px; padding: 0; width: 28px; height: 28px; display: flex; align-items: center; justify-content: center; line-height: 1;">├ù</button>
        </div>
