...
if ($current_category) {
    $current_category['name'] = 'Maintenance Free Batteries';
    $current_category['description'] = 'Discover our premium maintenance-free batteries delivering superior performance and extended lifespan.';
}
...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Discover our premium maintenance-free batteries delivering superior performance and extended lifespan.',
        'subcategories' => array(
            array('id' => 'maintenance-free', 'name' => 'Maintenance Free Batteries')
        )
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Discover our premium maintenance-free batteries delivering superior performance and extended lifespan.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch maintenance free battery products
                $all_products = andison_get_products_for_subcategory('batteries', 'maintenance-free');
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h4>Maintenance Free Batteries</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="Maintenance Free Batteries" data-type="Battery" data-brand="Motolite" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
