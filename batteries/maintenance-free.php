...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Maintenance-free batteries designed for heavy-duty and commercial applications with superior performance',
        'subcategories' => array(
            array('id' => 'maintenance-free', 'name' => 'Maintenance Free')
        )
    );
}
?>
...
<head>
    ...
    $category_description = 'Maintenance-free batteries designed for heavy-duty and commercial applications with superior performance';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Maintenance Free products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Maintenance Free" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
