...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Batteries',
        'description' => 'Discover our comprehensive range of maintenance-free batteries for industrial applications.',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Maintenance Free Batteries';
    $category_description = 'Discover our comprehensive range of maintenance-free batteries for industrial applications.';
    ?>
...
<?php $andisonNavBrandsPath = __DIR__ . '/includes/nav_brands_dropdown_items.php'; if (!is_file($andisonNavBrandsPath)) { $andisonNavBrandsPath = dirname(__DIR__) . '/includes/nav_brands_dropdown_items.php'; } if (!is_file($andisonNavBrandsPath)) { $andisonNavBrandsPath = dirname(dirname(__DIR__)) . '/includes/nav_brands_dropdown_items.php'; } if (is_file($andisonNavBrandsPath)) { include $andisonNavBrandsPath; } ?>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch products from the correct category
