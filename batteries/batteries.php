...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Batteries',
        'description' => 'Power your operations with our comprehensive range of high-performance batteries for industrial and commercial applications.',
        'subcategories' => array(
            array('id' => 'batteries', 'name' => 'Batteries')
        )
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Power your operations with our comprehensive range of high-performance batteries for industrial and commercial applications.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch battery products from all subcategories
                $subcategories = [
                    'low-maintenance',
                    'maintenance-free',
                    'special-batteries'
                ...
                foreach ($subcategories as $subcat) {
                    $products = andison_get_products_for_subcategory('batteries', $subcat);
                    if (!empty($products)) {
                ...
                <div class="product-card">
                    <div class="product-image">
                        <i class="bi bi-lightning-fill" style="font-size: 56px; color: #ccc;"></i>
                    </div>
                    <div class="product-info">
                        <h4>Batteries</h4>
