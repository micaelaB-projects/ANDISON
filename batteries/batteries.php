...
<body>
    ...
    <div class="mini-sidebar active" id="miniSidebar">
        ...
        <div class="mini-sidebar-icon active-icon has-sub" data-target="../batteries/batteries.php" title="Batteries"><i class="bi bi-lightning-fill"></i><span class="label">Batteries</span><span class="sub-indicator"><i class="bi bi-chevron-right"></i></span></div>
    ...
    <script>
        ...
        <script>
            ...
            document.addEventListener('click', function(e){
                ...
                window.location.href = '../batteries/batteries.php';
            });
        </script>
    </body>
    </html>
