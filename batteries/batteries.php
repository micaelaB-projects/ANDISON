...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Batteries',
        'description' => 'High-performance batteries for diverse industrial and commercial applications',
        'subcategories' => array(
...
<head>
    ...
    $category_description = 'High-performance batteries for diverse industrial and commercial applications';
    ?>
    ...
    <!-- Overlay Backdrop --><?php include $_SERVER['DOCUMENT_ROOT'] . '/ANDISON/includes/sidebar.php'; ?>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Batteries products
                $all_products = andison_get_products_for_subcategory('batteries', 'batteries');
