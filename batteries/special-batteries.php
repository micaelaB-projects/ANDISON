...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Advanced special-purpose batteries for unique high-performance applications',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Special Batteries';
    $category_description = 'Advanced special-purpose batteries for unique high-performance applications';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Special Batteries products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Special Batteries" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
