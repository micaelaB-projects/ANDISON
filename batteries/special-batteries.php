...
if ($current_category) {
    $current_category['name'] = 'Special Batteries';
    $current_category['description'] = 'Explore our specialized battery solutions for unique applications including solar and high-amperage systems.';
}
...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Explore our specialized battery solutions for unique applications including solar and high-amperage systems.',
        'subcategories' => array(
            array('id' => 'special-batteries', 'name' => 'Special Batteries')
        )
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Explore our specialized battery solutions for unique applications including solar and high-amperage systems.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch special battery products
                $all_products = andison_get_products_for_subcategory('batteries', 'special-batteries');
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h4>Special Batteries</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="Special Batteries" data-type="Battery" data-brand="Motolite" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
