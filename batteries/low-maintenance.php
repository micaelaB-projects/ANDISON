...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Reliable low-maintenance batteries for truck and commercial applications',
        'subcategories' => array(
            array('id' => 'low-maintenance', 'name' => 'Low Maintenance')
        )
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = 'Low Maintenance';
    $category_description = 'Reliable low-maintenance batteries for truck and commercial applications';
    ?>
    ...
    <!-- Overlay Backdrop --><?php include $_SERVER['DOCUMENT_ROOT'] . '/ANDISON/includes/sidebar.php'; ?>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Low Maintenance products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Low Maintenance" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
