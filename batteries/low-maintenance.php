...
// Override category with subcategory-specific information
if ($current_category) {
    $current_category['name'] = 'Low Maintenance Batteries';
    $current_category['description'] = 'Explore our range of reliable low-maintenance batteries designed for commercial and industrial applications.';
}
...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Explore our range of reliable low-maintenance batteries designed for commercial and industrial applications.',
        'subcategories' => array(
            array('id' => 'low-maintenance', 'name' => 'Low Maintenance Batteries')
        )
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Explore our range of reliable low-maintenance batteries designed for commercial and industrial applications.';
    ?>
...
<body>
    ...
    <div class="mini-sidebar active" id="miniSidebar">
        ...
        <div class="mini-sidebar-icon has-sub" data-target="batteries.php" title="Batteries"><i class="bi bi-lightning-fill"></i><span class="label">Batteries</span><span class="sub-indicator"><i class="bi bi-chevron-right"></i></span></div>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch low maintenance battery products
                $all_products = andison_get_products_for_subcategory('batteries', 'low-maintenance');
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Low Maintenance Batteries" data-type="Battery" data-brand="Motolite" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
