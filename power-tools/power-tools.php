...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Power Tools',
        'description' => 'Professional power tools for industrial and construction applications.',
        'subcategories' => array(
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Professional power tools for industrial and construction applications.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch power tool products from all subcategories
                $subcategories = [
                    'drill-and-wrench',
                    'grinder',
                    'rotary-and-demolition-hammer',
                    'saw',
                    'accessories'
                ];
                ...
                foreach ($subcategories as $subcat) {
                    $products = andison_get_products_for_subcategory('power-tools', $subcat);
                    if (!empty($products)) {
