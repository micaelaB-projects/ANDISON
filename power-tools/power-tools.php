...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Power Tools',
        'description' => 'Comprehensive range of professional-grade power tools including drills, grinders, saws, and demolition equipment',
        'subcategories' => array(
            array('id' => 'power-tools', 'name' => 'Power Tools')
        )
    );
}
?>
...
<head>
    ...
    $category_description = 'Comprehensive range of professional-grade power tools including drills, grinders, saws, and demolition equipment';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Power Tools products
                $all_products = andison_get_products_for_subcategory('power-tools', 'power-tools');
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Power Tools" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
