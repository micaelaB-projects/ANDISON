...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $subcategory_id,
        'name' => 'Grinder',
        'description' => 'Professional grinding tools for industrial applications.'
    );
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Grinder';
    $category_description = $current_category['description'] ?? 'Professional grinding tools for industrial applications.';
    ?>
...
<body>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Grinder'); ?></h2>
