...
if (!$current_category) {
    $current_category = array(
        'id' => $subcategory_id,
        'name' => 'Grinder',
        'description' => 'Professional-grade grinder tools and accessories for precision welding consumables.',
        'subcategories' => array()
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Professional grinder tools and accessories.';
    ?>
    <title><?php echo htmlspecialchars($category_name); ?> - Welding Consumables - ANDISON INDUSTRIAL</title>
