...
if (!$current_category) {
    die("Grinder category not found");
}

$page_title = $current_category['name'] ?? "Grinder";
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Professional-grade grinder tools for precision work and material finishing.';
    ?>
    ...
    <aside id="sidebar" class="sidebar-overlay" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="product-grid">
                <?php 
                // Dynamically fetch products for Grinder subcategory
                $all_products = array();
                ...
                <div class="product-card">
                    ...
                    <button class="add-to-inquiry" type="button" data-model="Grinder" data-type="Power Tool" data-brand="Industrial">ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
