...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Grinder',
        'description' => 'Professional-grade angle and straight grinders for cutting, grinding, and finishing applications',
        'subcategories' => array(
            array('id' => 'grinder', 'name' => 'Grinder')
        )
    );
}
?>
...
<head>
    ...
    $category_description = 'Professional-grade angle and straight grinders for cutting, grinding, and finishing applications';
    ?>
    ...
    <!-- Overlay Backdrop --><?php include $_SERVER['DOCUMENT_ROOT'] . '/ANDISON/includes/sidebar.php'; ?>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Grinder products
                $all_products = andison_get_products_for_subcategory('power-tools', 'grinder');
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Grinder" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
