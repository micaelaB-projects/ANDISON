...
$current_category['name'] = 'Rotary and Demolition Hammer';
$current_category['description'] = 'Professional rotary hammers and demolition tools for drilling and breaking.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    $category_description = $current_category['description'] ?? 'Professional rotary hammers and demolition tools for drilling and breaking.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch rotary and demolition hammer products
