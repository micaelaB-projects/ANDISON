...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Professional rotary hammers and demolition equipment for heavy-duty drilling, chiseling, and breaking applications',
        'subcategories' => array(
            array('id' => 'rotary-and-demolition-hammer', 'name' => 'Rotary and Demolition Hammer')
        )
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = 'Rotary and Demolition Hammer';
    $category_description = 'Professional rotary hammers and demolition equipment for heavy-duty drilling, chiseling, and breaking applications';
    ?>
...
<body>
    ...
    <header>
        ...
        <div class="category-content">
            <h2>Rotary and Demolition Hammer</h2>
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Rotary and Demolition Hammer products
                $all_products = andison_get_products_for_subcategory('power-tools', 'rotary-and-demolition-hammer');
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h4>Rotary and Demolition Hammer</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="Rotary and Demolition Hammer" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
