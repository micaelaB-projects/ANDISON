...
$subcategory_id = "rotary-and-demolition-hammer";
...
if (!$current_category) {
    die("Rotary and Demolition Hammer category not found");
}

$page_title = $current_category['name'] ?? "Rotary and Demolition Hammer";
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Rotary and Demolition Hammer';
    $category_description = $current_category['description'] ?? 'High-performance rotary and demolition hammers for heavy-duty applications and material breaking.';
    ?>
...
<body>
    ...
    <aside id="sidebar" class="sidebar-overlay" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Rotary and Demolition Hammer'); ?></h2>
            ...
            <div class="product-grid">
                <?php 
                // Dynamically fetch products for Rotary and Demolition Hammer subcategory
                $all_products = array();
                ...
                <div class="product-card">
                    ...
                    // Fallback products if no products from database
                    $fallback_products = array(
                        array(
                            'name' => 'Bosch Rotary Hammer with SDS Plus GBH 4-32DFR',
                            'model' => 'GBH 4-32DFR',
                            'type' => 'Rotary Hammer',
                            'brand' => 'Bosch',
                            'description' => 'Heavy-duty rotary hammer with SDS Plus chuck for concrete and stone drilling'
                        ),
                        array(
                            'name' => 'Bosch Demolition Hammer with SDS Max GSH 5',
                            'model' => 'GSH 5',
                            'type' => 'Demolition Hammer',
                            'brand' => 'Bosch',
                            'description' => 'Powerful demolition hammer with SDS Max system for breaking and chiseling'
                        ),
                        array(
                            'name' => 'GSH 16-30 Demolition Jack Hammer',
                            'model' => 'GSH 16-30',
                            'type' => 'Jack Hammer',
                            'brand' => 'Bosch',
                            'description' => 'Heavy-duty jack hammer for intensive demolition and concrete breaking'
                        )
                    );
