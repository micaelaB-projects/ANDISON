...
// Set category and subcategory for Rotary and Demolition Hammer
...
if (!$current_category) {
    $current_category = array(
        'id' => $category_id,
        'name' => 'Power Tools',
        'description' => 'Discover our comprehensive range of power tools and equipment for professional and industrial use.',
        'subcategories' => array(
