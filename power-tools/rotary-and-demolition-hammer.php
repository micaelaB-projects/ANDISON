...
$page_title = "Rotary and Demolition Hammer";
...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $subcategory_id,
        'name' => 'Rotary and Demolition Hammer',
        'description' => 'Professional rotary and demolition hammer tools for industrial applications.'
    );
}
?>
<!DOCTYPE html>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Professional rotary and demolition hammer tools for industrial applications.';
    ?>
