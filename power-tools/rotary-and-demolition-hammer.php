...
<head>
    ...
    <title>Rotary and Demolition Hammer - Welding Consumables - ANDISON INDUSTRIAL</title>
...
<body>
    ...
    <div class="category-container">
        <div class="category-header">
            <h1>Rotary and Demolition Hammer</h1>
            <p>High-performance rotary and demolition hammer welding consumables for heavy-duty applications.</p>
        </div>
    </div>
