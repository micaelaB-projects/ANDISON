...
if (!$current_category) {
    die("Drill and Wrench category not found");
}

$page_title = $current_category['name'] ?? "Drill and Wrench";
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Professional-grade drilling and wrench tools for precision fastening and material assembly.';
    ?>
    ...
    <aside id="sidebar" class="sidebar-overlay" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="product-grid">
                <?php 
                // Dynamically fetch products for Drill and Wrench subcategory
                $all_products = array();
                ...
                <div class="product-card">
                    ...
                    <h4>Drill and Wrench Tools</h4>
                    <p class="product-type">No products available</p>
                    <button class="add-to-inquiry" type="button" data-model="Drill and Wrench" data-type="Power Tool" data-brand="Industrial">ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
