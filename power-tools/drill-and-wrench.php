...
$page_title = "Drill and Wrench";
$category_id = "power-tools";
$subcategory_id = "drill-and-wrench";
...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $subcategory_id,
        'name' => 'Drill and Wrench',
        'description' => 'Professional drill and wrench tools for industrial applications.'
    );
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Drill and Wrench';
    $category_description = $current_category['description'] ?? 'Professional drill and wrench tools for industrial applications.';
    ?>
...
<body>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Drill and Wrench'); ?></h2>
