...
$current_category = array(
    'id' => $subcategory_id,
    'name' => 'Saw',
    'description' => 'Precision saw tools and welding consumable materials for cutting applications.',
    'subcategories' => array()
);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Saw - Welding Consumables - ANDISON INDUSTRIAL</title>
...
<body>
    ...
    <aside id="sidebar" class="sidebar-overlay" aria-hidden="true">
        ...
        <ul class="sidebar-list">
            <li class="has-sub">
                <a href="../arc-welding-machine/arc-welding-machine.php"><span class="sidebar-icon"><i class="bi bi-lightning-charge"></i></span><span class="sidebar-label">Arc Welding Machines</span></a>
                <button class="sub-toggle" aria-expanded="false" aria-controls="sub-arc-welding"><i class="bi bi-chevron-right"></i></button>
            ...
            <li class="has-sub">
                <a href="../power-tools/power-tools.php"><span class="sidebar-icon"><i class="bi bi-tools"></i></span><span class="sidebar-label">Power Tools</span></a>
                <button class="sub-toggle" aria-expanded="false" aria-controls="sub-power-tool"><i class="bi bi-chevron-right"></i></button>
    ...
    <div class="category-container">
        <div class="category-header">
            <h1>Saw</h1>
            <p>Precision saw tools and welding consumable materials for cutting applications.</p>
        </div>
    </div>
