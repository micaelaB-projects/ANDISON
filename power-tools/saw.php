...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Saw',
        'description' => 'Professional-grade saws for cutting wood, metal, and composite materials with precision',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Saw';
    $category_description = 'Professional-grade saws for cutting wood, metal, and composite materials with precision';
    ?>
            ...
            <div class="main-product-area">
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Saw" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
