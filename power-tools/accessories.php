...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Accessories',
        'description' => 'Essential power tool accessories including brushes, burrs, and maintenance supplies',
        'subcategories' => array(
...
<head>
    ...
    $category_description = 'Essential power tool accessories including brushes, burrs, and maintenance supplies';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Accessories products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Accessories" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
