...
$page_title = $current_category['name'] ?? "Accessories";
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Professional-grade power tool accessories for enhanced productivity and equipment maintenance.';
    ?>
    ...
    <aside id="sidebar" class="sidebar-overlay" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="product-grid">
                <?php 
                // Dynamically fetch products for Accessories subcategory
                $all_products = array();
                ...
                <div class="product-card">
                    ...
                    $fallback_products = array(
                        array(
                            'name' => 'Weiler Industrial Wire Brushes',
                            'model' => 'Wire Brush Set',
                            'type' => 'Accessories',
                            'brand' => 'Weiler',
                            'description' => 'Industrial-grade wire brushes for cleaning and surface preparation'
                        ),
                        array(
                            'name' => 'Garryson Tungsten Carbide Burrs',
                            'model' => 'Carbide Burr Assortment',
                            'type' => 'Accessories',
                            'brand' => 'Garryson',
                            'description' => 'Precision tungsten carbide burrs for grinding and shaping'
                        )
                    );
                    ...
                    foreach ($fallback_products as $product) {
                        $name = htmlspecialchars($product['name'] ?? '');
                        $model = htmlspecialchars($product['model'] ?? '');
                        $type = htmlspecialchars($product['type'] ?? 'Accessories');
                        $brand = htmlspecialchars($product['brand'] ?? 'Industrial');
                        $description = htmlspecialchars($product['description'] ?? '');
                        ?>
                <div class="product-card">
