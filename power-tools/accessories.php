...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $subcategory_id,
        'name' => 'Accessories',
        'description' => 'Power tool accessories and replacement parts for industrial applications.'
    );
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Accessories';
    $category_description = $current_category['description'] ?? 'Power tool accessories and replacement parts for industrial applications.';
    ?>
...
<body>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Accessories'); ?></h2>
