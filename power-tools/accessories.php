...
<head>
    ...
    <title>Accessories - Welding Consumables - ANDISON INDUSTRIAL</title>
...
<body>
    ...
    <div class="category-container">
        <div class="category-header">
            <h1>Welding Consumables Accessories</h1>
            <p>Complete range of accessories for welding consumables and tools.</p>
        </div>
    </div>
