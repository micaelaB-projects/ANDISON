...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Professional portable ventilation equipment for confined spaces.',
        'subcategories' => array(
...
$current_category['name'] = 'Pneumatic Driven';
$current_category['description'] = 'Pneumatic-powered ventilation systems for industrial applications.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Pneumatic Driven';
    $category_description = $current_category['description'] ?? 'Pneumatic-powered ventilation systems for industrial applications.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch pneumatic-driven ventilator products
                $all_products = andison_get_products_for_subcategory('portable-ventilators', 'pneumatic-driven');
                ...
                if (!empty($all_products)) {
                    foreach ($all_products as $product) {
                        ...
                        $type = htmlspecialchars($product['type'] ?? 'Ventilator');
                ...
                <div class="product-card">
                    <div class="product-image">
                        <?php if (!empty($image_src)): ?>
                            <img src="<?php echo $image_src; ?>" alt="<?php echo $name; ?>" onerror="this.parentElement.innerHTML='<i class=&quot;bi bi-fan&quot; style=&quot;font-size: 56px; color: #ccc;&quot;></i>'">
                        <?php else: ?>
                            <i class="bi bi-fan" style="font-size: 56px; color: #ccc;"></i>
                        <?php endif; ?>
                        <?php if (!empty($badge)): ?>
