...
$subcategory_id = "pneumatic-driven";
...
foreach ($categories as $cat) {
    if ($cat['id'] === 'portable-ventilators') {
        $parent_category = $cat;
...
if (!$current_category) {
    die("Pneumatic Driven Ventilators category not found");
}

$page_title = $current_category['name'] ?? "Pneumatic Driven";
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Pneumatic Driven Ventilators';
    $category_description = $current_category['description'] ?? 'Professional pneumatic-driven portable ventilation equipment for industrial applications.';
    ?>
...
<body>
    ...
    <div class="category-container">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Pneumatic Driven Ventilators'); ?></h2>
            ...
            <div class="product-grid">
                ...
                if (!empty($all_products)) {
                    foreach ($all_products as $product) {
                        ...
                        $type = htmlspecialchars($product['type'] ?? 'Ventilation Equipment');
                ...
                <div class="product-card">
                    <div class="product-image">
                        <?php if (!empty($image_src)): ?>
                            <img src="<?php echo $image_src; ?>" alt="<?php echo $name; ?>" onerror="this.parentElement.innerHTML='<i class=&quot;bi bi-fan&quot; style=&quot;font-size: 60px; color: #ccc;&quot;></i>'">
                        <?php else: ?>
                            <i class="bi bi-fan" style="font-size: 60px; color: #ccc;"></i>
                        <?php endif; ?>
                        <?php if (!empty($badge)): ?>
                ...
                <div class="product-card">
                    ...
                    <h4>Pneumatic Driven Ventilators</h4>
                    <p class="product-type">No products available</p>
                    <button class="add-to-inquiry" type="button" data-model="Pneumatic Driven Ventilator" data-type="Ventilation Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
