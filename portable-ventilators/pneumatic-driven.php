...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Pneumatic-powered portable ventilation equipment for industrial air circulation and cooling',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Pneumatic Driven';
    $category_description = 'Pneumatic-powered portable ventilation equipment for industrial air circulation and cooling';
    ?>
    ...
    <!-- Overlay Backdrop --><?php include $_SERVER['DOCUMENT_ROOT'] . '/ANDISON/includes/sidebar.php'; ?>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Pneumatic Driven products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h4>Pneumatic Driven</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="Pneumatic Driven" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
