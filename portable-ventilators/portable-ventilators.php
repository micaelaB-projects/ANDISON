...
<body class="brand-page">
    ...
    <aside id="sidebar" class="sidebar-overlay" aria-hidden="true">
        ...
        <ul class="sidebar-list">
            ...
            <li class="has-sub">
                <a href="./portable-ventilators.php"><span class="sidebar-icon" aria-hidden="true"><i class="bi bi-fan"></i></span><span class="sidebar-label">Portable Ventilators</span></a>
                ...
                <ul id="sub-ventilators" class="sidebar-sublist collapsed">
                    <li><a href="./portable-ventilator-accessories.php">Portable Ventilator Accessories</a></li>
                </ul>
            </li>
            <li class="has-sub">
