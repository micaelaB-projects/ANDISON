...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Explore our comprehensive range of portable ventilators and automated welding systems from leading manufacturers.';
    $phone = "+1(234) 567 8900";
    $phone2 = "+1(234) 567 8900";
    $phone3 = "+1(639) 977 803 7398";
    $email = "info@andison-industrial.com";
    ...
    <script>
        ...
        <script>
            ...
            document.addEventListener('click', function(e){
                ...
                window.location.href = '../portable-ventilators/portable-ventilators.php';
            });
        </script>
    </body>
    </html>
