...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Professional portable ventilation equipment for confined spaces.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch portable ventilator products from all subcategories
                $subcategories = [
                    'electric-driven',
                    'pneumatic-driven'
                ];
                ...
                foreach ($subcategories as $subcat) {
                    $products = andison_get_products_for_subcategory('portable-ventilators', $subcat);
                    if (!empty($products)) {
