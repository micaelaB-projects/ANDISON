...
$page_title = "Portable Ventilators";
$category_id = "portable-ventilators";
$subcategory_id = "portable-ventilators";
...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Discover our comprehensive range of portable ventilation equipment for industrial air quality management.',
        'subcategories' => array(
            array('id' => 'portable-ventilators', 'name' => 'Portable Ventilators')
        )
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Portable Ventilators';
    $category_description = $current_category['description'] ?? 'Discover our comprehensive range of portable ventilation equipment for industrial air quality management.';
    ?>
...
<body>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Portable Ventilators'); ?></h2>
