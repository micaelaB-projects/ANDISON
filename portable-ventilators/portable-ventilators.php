...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Comprehensive range of portable ventilation equipment including electric-driven and pneumatic-driven systems',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Portable Ventilators';
    $category_description = 'Comprehensive range of portable ventilation equipment including electric-driven and pneumatic-driven systems';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Portable Ventilators products
                $all_products = andison_get_products_for_subcategory('portable-ventilators', 'portable-ventilators');
