...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Explore our comprehensive range of Portable Ventilators';
    $phone = "+1(234) 567 8900";
    $phone2 = "+1(234) 567 8900";
    $phone3 = "+1(639) 977 803 7398";
    $email = "info@andison-industrial.com";
...
<body>
    ...
    <div class="mini-sidebar active" id="miniSidebar">
        ...
        <div class="mini-sidebar-icon active-icon has-sub" data-target="../portable-ventilators/portable-ventilators.php" title="Portable Ventilators"><i class="bi bi-fan"></i><span class="label">Portable Ventilators</span><span class="sub-indicator"><i class="bi bi-chevron-right"></i></span></div>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        <div class="mini-popover-header">
            <div class="mini-popover-title">Portable Ventilators</div>
        </div>
    ...
    <script>
        ...
        <script>
            ...
            document.addEventListener('click', function(e){
                ...
                window.location.href = '../gas-detectors/gas-detectors.php';
            });
        </script>
    </body>
    </html>
