...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Electric-powered portable ventilation equipment for industrial air circulation and cooling',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Electric Driven';
    $category_description = 'Electric-powered portable ventilation equipment for industrial air circulation and cooling';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Electric Driven products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h4>Electric Driven</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="Electric Driven" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
