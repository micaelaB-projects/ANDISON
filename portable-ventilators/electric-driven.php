...
$current_category['name'] = 'Electric Driven';
$current_category['description'] = 'Electric-powered ventilation systems for industrial applications.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Electric Driven';
    $category_description = $current_category['description'] ?? 'Electric-powered ventilation systems for industrial applications.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch electric-driven ventilator products
                $all_products = andison_get_products_for_subcategory('portable-ventilators', 'electric-driven');
