...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $subcategory_id,
        'name' => 'Eye Protection',
        'description' => 'Professional eye protection equipment for industrial safety.'
    );
}
?>
<!DOCTYPE html>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Professional eye protection equipment for industrial safety.';
    ?>
...
<body>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Eye Protection'); ?></h2>
