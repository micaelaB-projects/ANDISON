...
$page_title = "Eye Protection";
$category_id = "protection";
$subcategory_id = "eye-protection";
...
$current_category['name'] = 'Eye Protection';
$current_category['description'] = 'Eye safety equipment for industrial and construction environments.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Eye Protection';
    $category_description = $current_category['description'] ?? 'Eye safety equipment for industrial and construction environments.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                $all_products = andison_get_products_for_subcategory('protection', 'eye-protection');
