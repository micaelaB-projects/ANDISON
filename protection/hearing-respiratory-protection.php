...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $subcategory_id,
        'name' => 'Hearing & Respiratory Protection',
        'description' => 'Hearing and respiratory protection equipment for hazardous environments.',
        'subcategories' => array()
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Hearing and respiratory protection equipment for hazardous environments.';
    ?>
...
<body>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Hearing & Respiratory Protection'); ?></h2>
            ...
            <div class="product-grid">
                <?php 
                // Dynamically fetch products for hearing-respiratory-protection
                $all_products = array();
