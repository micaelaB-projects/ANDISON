...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Protection',
        'description' => 'Comprehensive industrial protective equipment for worker safety',
        'subcategories' => array(
            array('id' => 'hearing-respiratory-protection', 'name' => 'Hearing and Respiratory Protection')
        )
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = 'Hearing and Respiratory Protection';
    $category_description = 'Protective equipment for hearing and respiratory safety in industrial environments';
    ?>
...
<body>
    ...
    <header>
        ...
        <div class="category-content">
            <h2>Hearing and Respiratory Protection</h2>
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Hearing and Respiratory Protection products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h4>Hearing and Respiratory Protection</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="Hearing and Respiratory Protection" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
