...
$page_title = "Hearing and Respiratory Protection";
$category_id = "protection";
$subcategory_id = "hearing-respiratory-protection";
...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $subcategory_id,
        'name' => 'Hearing and Respiratory Protection',
        'description' => 'Professional hearing and respiratory protection equipment for industrial safety.'
    );
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Hearing and Respiratory Protection';
    $category_description = $current_category['description'] ?? 'Professional hearing and respiratory protection equipment for industrial safety.';
    ?>
...
<body>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Hearing and Respiratory Protection'); ?></h2>
            ...
            <div class="product-grid">
                ...
                <div class="product-card">
                    ...
                    <h4>Portable Ventilators</h4>
                    <p class="product-type">No products available</p>
                    <button class="add-to-inquiry" type="button" data-model="Portable Ventilators" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
