...
$page_title = "Hearing & Respiratory Protection";
...
$current_category['name'] = 'Hearing & Respiratory Protection';
$current_category['description'] = 'Essential hearing and respiratory safety equipment.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Hearing & Respiratory Protection';
    $category_description = $current_category['description'] ?? 'Essential hearing and respiratory safety equipment.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                $all_products = andison_get_products_for_subcategory('protection', 'hearing-respiratory-protection');
