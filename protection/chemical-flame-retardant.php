...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $subcategory_id,
        'name' => 'Saw',
        'description' => 'Professional saw tools for industrial applications.'
    );
}
?>
<!DOCTYPE html>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Professional saw tools for industrial applications.';
    ?>
