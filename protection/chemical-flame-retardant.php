...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Chemical Flame Retardant',
        'description' => 'Advanced chemical flame-retardant protective clothing and equipment for hazardous environments',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Chemical Flame Retardant';
    $category_description = 'Advanced chemical flame-retardant protective clothing and equipment for hazardous environments';
    ?>
...
<body>
    ...
    <header>
        ...
        <div class="category-content">
            <h2>Chemical Flame Retardant</h2>
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Chemical Flame Retardant products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h4>Chemical Flame Retardant</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="Chemical Flame Retardant" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
