...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Protective equipment with chemical and flame retardant properties.',
        'subcategories' => array()
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Chemical and Flame Retardant';
    $category_description = $current_category['description'] ?? 'Protective equipment with chemical and flame retardant properties.';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="product-grid">
                <?php 
                // Dynamically fetch products for chemical-flame-retardant
                $all_products = array();
