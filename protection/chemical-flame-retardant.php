...
$page_title = "Chemical & Flame Retardant";
...
$current_category['name'] = 'Chemical & Flame Retardant';
$current_category['description'] = 'Advanced chemical and flame retardant protective gear.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Chemical & Flame Retardant';
    $category_description = $current_category['description'] ?? 'Advanced chemical and flame retardant protective gear.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                $all_products = andison_get_products_for_subcategory('protection', 'chemical-flame-retardant');
