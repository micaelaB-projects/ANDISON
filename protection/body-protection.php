...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Protective body gear and apparel for industrial workers and hazardous environments',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Body Protection';
    $category_description = 'Protective body gear and apparel for industrial workers and hazardous environments';
    ?>
    ...
    <!-- Overlay Backdrop --><?php include $_SERVER['DOCUMENT_ROOT'] . '/ANDISON/includes/sidebar.php'; ?>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Body Protection products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Body Protection" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
