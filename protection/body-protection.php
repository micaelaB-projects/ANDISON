...
$page_title = "Body Protection";
$category_id = "protection";
$subcategory_id = "body-protection";
...
$current_category['name'] = 'Body Protection';
$current_category['description'] = 'Complete body protection solutions for hazardous work environments.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    $category_description = $current_category['description'] ?? 'Complete body protection solutions for hazardous work environments.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                $all_products = andison_get_products_for_subcategory('protection', 'body-protection');
