...
$current_category['name'] = 'Working Gloves';
$current_category['description'] = 'Versatile working gloves for general industrial use.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    $category_description = $current_category['description'] ?? 'Versatile working gloves for general industrial use.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                $all_products = andison_get_products_for_subcategory('protection', 'working-gloves');
