...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $subcategory_id,
        'name' => 'Working Gloves',
        'description' => 'Professional working gloves for industrial protection.'
    );
}
?>
<!DOCTYPE html>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Professional working gloves for industrial protection.';
    ?>
