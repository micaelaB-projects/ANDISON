...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Working Gloves',
        'description' => 'Professional work gloves and protective hand gear for industrial tasks and labor',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Working Gloves';
    $category_description = 'Professional work gloves and protective hand gear for industrial tasks and labor';
    ?>
    ...
    <!-- Overlay Backdrop --><?php include $_SERVER['DOCUMENT_ROOT'] . '/ANDISON/includes/sidebar.php'; ?>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Working Gloves products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h4>Working Gloves</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="Working Gloves" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
