...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Professional welding head and face protection equipment including helmets, visors, and protective gear',
        'subcategories' => array(
            array('id' => 'welding-head-and-face-protection', 'name' => 'Welding Head and Face Protection')
        )
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = 'Welding Head and Face Protection';
    $category_description = 'Professional welding head and face protection equipment including helmets, visors, and protective gear';
    ?>
...
<body>
    ...
    <header>
        ...
        <div class="category-content">
            <h2>Welding Head and Face Protection</h2>
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Welding Head and Face Protection products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Welding Head and Face Protection" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
