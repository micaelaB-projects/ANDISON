...
$page_title = "Welding Head & Face Protection";
...
$current_category['name'] = 'Welding Head & Face Protection';
$current_category['description'] = 'Complete head and face protection for welding operations.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Welding Head & Face Protection';
    $category_description = $current_category['description'] ?? 'Complete head and face protection for welding operations.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                $all_products = andison_get_products_for_subcategory('protection', 'welding-head-and-face-protection');
