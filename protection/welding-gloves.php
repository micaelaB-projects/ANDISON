...
$page_title = "Welding Gloves";
$category_id = "protection";
$subcategory_id = "welding-gloves";
...
$current_category['name'] = 'Welding Gloves';
$current_category['description'] = 'Durable gloves designed specifically for welding applications.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Welding Gloves';
    $category_description = $current_category['description'] ?? 'Durable gloves designed specifically for welding applications.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                $all_products = andison_get_products_for_subcategory('protection', 'welding-gloves');
