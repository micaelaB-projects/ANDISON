...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Welding Gloves',
        'description' => 'Professional welding gloves and hand protection equipment for various welding applications',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Welding Gloves';
    $category_description = 'Professional welding gloves and hand protection equipment for various welding applications';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Welding Gloves products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Welding Gloves" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
