...
$page_title = "Liquid Spray and Splash";
$category_id = "protection";
$subcategory_id = "liquid-spray-splash";
...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $subcategory_id,
        'name' => 'Liquid Spray and Splash',
        'description' => 'Professional liquid spray and splash protection equipment.'
    );
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Liquid Spray and Splash';
    $category_description = $current_category['description'] ?? 'Professional liquid spray and splash protection equipment.';
    ?>
...
<body>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Liquid Spray and Splash'); ?></h2>
