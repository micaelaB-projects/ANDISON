...
$page_title = "Liquid Spray & Splash Protection";
...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'subcategories' => array(
            array('id' => 'liquid-spray-splash', 'name' => 'Liquid Spray & Splash Protection')
        )
    );
}

// Override category for subcategory-specific display
$current_category['name'] = 'Liquid Spray & Splash Protection';
$current_category['description'] = 'Protection against liquid sprays and splashes.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Liquid Spray & Splash Protection';
    $category_description = $current_category['description'] ?? 'Protection against liquid sprays and splashes.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                $all_products = andison_get_products_for_subcategory('protection', 'liquid-spray-splash');
