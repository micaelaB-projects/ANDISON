...
<head>
    ...
    <?php 
    $category_name = 'Liquid Spray Splash Protection';
    $category_description = 'Protective equipment for liquid spray and splash hazards';
    ?>
...
<body>
    ...
    <header>
        ...
        <div class="category-content">
            <h2>Liquid Spray Splash Protection</h2>
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Liquid Spray Splash Protection products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h4>Liquid Spray Splash Protection</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="Liquid Spray Splash Protection" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
