...
$page_title = "Chemical Liquid Protection Gloves";
$category_id = "protection";
$subcategory_id = "chemical-liquid-protection-gloves";
...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $subcategory_id,
        'name' => 'Chemical Liquid Protection Gloves',
        'description' => 'Professional chemical and liquid protection gloves for hazardous environments.'
    );
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Chemical Liquid Protection Gloves';
    $category_description = $current_category['description'] ?? 'Professional chemical and liquid protection gloves for hazardous environments.';
    ?>
...
<body>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Chemical Liquid Protection Gloves'); ?></h2>
