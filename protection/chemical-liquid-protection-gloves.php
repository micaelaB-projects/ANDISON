...
$page_title = "Chemical and Liquid Protection Gloves";
...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $subcategory_id,
        'name' => 'Chemical and Liquid Protection Gloves',
        'description' => 'Specialized gloves offering chemical and liquid protection.',
        'subcategories' => array()
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Chemical and Liquid Protection Gloves';
    $category_description = $current_category['description'] ?? 'Specialized gloves offering chemical and liquid protection.';
    ?>
...
<body>
    ...
    <aside id="sidebar" class="sidebar-overlay" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Chemical and Liquid Protection Gloves'); ?></h2>
            ...
            <div class="product-grid">
                <?php 
                // Dynamically fetch products for chemical-liquid-protection-gloves
                $all_products = array();
