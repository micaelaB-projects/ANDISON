...
// Set category and subcategory for Chemical Liquid Protection Gloves
...
if (!$current_category) {
    $current_category = array(
        'id' => $category_id,
        'name' => 'Protection',
        'description' => 'Discover our comprehensive range of protective equipment and solutions for workplace safety.',
        'subcategories' => array(
