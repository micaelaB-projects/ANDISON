...
$current_category['name'] = 'Chemical & Liquid Protection Gloves';
$current_category['description'] = 'Specialized gloves for chemical and liquid handling.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    $category_description = $current_category['description'] ?? 'Specialized gloves for chemical and liquid handling.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                $all_products = andison_get_products_for_subcategory('protection', 'chemical-liquid-protection-gloves');
