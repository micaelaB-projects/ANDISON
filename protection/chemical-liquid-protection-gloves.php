...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Protection',
        'description' => 'Industrial safety and protective equipment for hazardous environments',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Chemical Liquid Protection Gloves';
    $category_description = 'Chemical-resistant gloves for hazardous liquid handling and protection';
    ?>
...
<body>
    ...
    <header>
        ...
        <div class="category-content">
            <h2>Chemical Liquid Protection Gloves</h2>
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Chemical Liquid Protection Gloves products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h4>Chemical Liquid Protection Gloves</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="Chemical Liquid Protection Gloves" data-type="Protective Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
