...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'High-quality disposable gloves for hygiene and protection.',
        'subcategories' => array()
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'High-quality disposable gloves for hygiene and protection.';
    ?>
    ...
    <aside id="sidebar" class="sidebar-overlay" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="product-grid">
                <?php 
                // Dynamically fetch products for disposable-gloves
                $all_products = array();
