...
$current_category['name'] = 'Disposable Gloves';
$current_category['description'] = 'Hygienic disposable gloves for various applications.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    $category_description = $current_category['description'] ?? 'Hygienic disposable gloves for various applications.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                $all_products = andison_get_products_for_subcategory('protection', 'disposable-gloves');
