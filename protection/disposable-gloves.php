...
$page_title = "Disposable Gloves";
$category_id = "protection";
$subcategory_id = "disposable-gloves";
...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Professional disposable gloves for various industrial applications.'
    );
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Disposable Gloves';
    $category_description = $current_category['description'] ?? 'Professional disposable gloves for various industrial applications.';
    ?>
...
<body>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Disposable Gloves'); ?></h2>
