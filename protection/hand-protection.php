...
$current_category['name'] = 'Hand Protection';
$current_category['description'] = 'Comprehensive hand protection solutions for workplace safety.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    $category_description = $current_category['description'] ?? 'Comprehensive hand protection solutions for workplace safety.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                $all_products = andison_get_products_for_subcategory('protection', 'hand-protection');
