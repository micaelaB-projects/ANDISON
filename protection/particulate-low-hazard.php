...
$page_title = "Particulate Low Hazard";
...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $subcategory_id,
        'name' => 'Particulate Low Hazard',
        'description' => 'Low hazard particulate protection equipment for industrial environments.'
    );
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Particulate Low Hazard';
    $category_description = $current_category['description'] ?? 'Low hazard particulate protection equipment for industrial environments.';
    ?>
...
<body>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Particulate Low Hazard'); ?></h2>
