...
$page_title = "Particulate and Low Hazard";
...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $subcategory_id,
        'name' => 'Particulate and Low Hazard',
        'description' => 'Particulate and low hazard protection equipment.',
        'subcategories' => array()
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Particulate and Low Hazard';
    $category_description = $current_category['description'] ?? 'Particulate and low hazard protection equipment.';
    ?>
...
<body>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Particulate and Low Hazard'); ?></h2>
            ...
            <div class="product-grid">
                <?php 
                // Dynamically fetch products for particulate-low-hazard
                $all_products = array();
