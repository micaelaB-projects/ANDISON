...
$page_title = "Particulate Low Hazard Protection";
$category_id = "protection";
$subcategory_id = "particulate-low-hazard";
...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'subcategories' => array(
            array('id' => 'particulate-low-hazard', 'name' => 'Particulate Low Hazard Protection')
        )
    );
}

// Override category for subcategory-specific display
$current_category['name'] = 'Particulate Low Hazard Protection';
$current_category['description'] = 'Protection equipment for low-hazard particulate environments.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Particulate Low Hazard Protection';
    $category_description = $current_category['description'] ?? 'Protection equipment for low-hazard particulate environments.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                $all_products = andison_get_products_for_subcategory('protection', 'particulate-low-hazard');
