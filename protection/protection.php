...
$page_title = "Persoanal Protective Equipment";
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Explore our comprehensive range of personal protective equipment from leading manufacturers.';
    $phone = "+1(234) 567 8900";
    $phone2 = "+1(234) 567 8900";
    $phone3 = "+1(639) 977 803 7398";
    $email = "info@andison-industrial.com";
...
<body>
    ...
    <div class="mini-sidebar active" id="miniSidebar">
        ...
        <div class="mini-sidebar-icon active-icon has-sub" data-target="../protection/protection.php" title="Personal Protective Equipment"><i class="bi bi-shield-check"></i><span class="label">PPE</span><span class="sub-indicator"><i class="bi bi-chevron-right"></i></span></div>
    ...
    <script>
        ...
        <script>
            ...
            document.addEventListener('click', function(e){
                ...
                window.location.href = '../protection/protection.php';
            });
        </script>
    </body>
    </html>
