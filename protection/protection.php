...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Comprehensive PPE solutions for workplace safety and protection.',
        'subcategories' => array(
            array('id' => 'body-protection', 'name' => 'Body Protection'),
            array('id' => 'eye-protection', 'name' => 'Eye Protection'),
            array('id' => 'hand-protection', 'name' => 'Hand Protection'),
            array('id' => 'hearing-respiratory-protection', 'name' => 'Hearing & Respiratory Protection'),
            array('id' => 'welding-gloves', 'name' => 'Welding Gloves'),
            array('id' => 'welding-head-and-face-protection', 'name' => 'Welding Head & Face Protection'),
            array('id' => 'working-gloves', 'name' => 'Working Gloves'),
            array('id' => 'disposable-gloves', 'name' => 'Disposable Gloves'),
            array('id' => 'chemical-liquid-protection-gloves', 'name' => 'Chemical Liquid Protection Gloves'),
            array('id' => 'chemical-flame-retardant', 'name' => 'Chemical Flame Retardant'),
            array('id' => 'liquid-spray-splash', 'name' => 'Liquid Spray Splash'),
            array('id' => 'particulate-low-hazard', 'name' => 'Particulate Low Hazard')
        )
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Comprehensive PPE solutions for workplace safety and protection.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch protection products from all subcategories
                $subcategories = [
                    'body-protection',
                    'eye-protection',
                    'hand-protection',
                    ...
                    'welding-gloves',
                    'welding-head-and-face-protection',
                    'working-gloves',
                    'disposable-gloves',
                    'chemical-liquid-protection-gloves',
                    'chemical-flame-retardant',
                    'liquid-spray-splash',
                    'particulate-low-hazard'
                ];
                
                $all_products = [];
                foreach ($subcategories as $subcat) {
                    $products = andison_get_products_for_subcategory('protection', $subcat);
                    if (!empty($products)) {
                ...
                if (!empty($all_products)) {
                    foreach ($all_products as $product) {
                        ...
                        $type = htmlspecialchars($product['type'] ?? 'PPE');
                        $brand = htmlspecialchars($product['brand'] ?? 'Safety');
                ...
                <div class="product-card">
                    <div class="product-image">
                        <?php if (!empty($image_src)): ?>
                            <img src="<?php echo $image_src; ?>" alt="<?php echo $name; ?>" onerror="this.parentElement.innerHTML='<i class=&quot;bi bi-shield-check&quot; style=&quot;font-size: 56px; color: #ccc;&quot;></i>'">
                        <?php else: ?>
                            <i class="bi bi-shield-check" style="font-size: 56px; color: #ccc;"></i>
                        <?php endif; ?>
                        <?php if (!empty($badge)): ?>
