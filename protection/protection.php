...
<body class="brand-page">
    ...
    <aside id="sidebar" class="sidebar-overlay" aria-hidden="true">
        ...
        <ul class="sidebar-list">
            ...
            <li class="has-sub">
                <a href="./protection.php"><span class="sidebar-icon" aria-hidden="true"><i class="bi bi-shield-check"></i></span><span class="sidebar-label">Protection and Safety</span></a>
                ...
                <ul id="sub-protection-safety" class="sidebar-sublist collapsed">
                    ...
                    <li><a href="./hand-protection.php">Hand Protection</a></li>
                    <li><a href="./hearing-respiratory-protection.php">Hearing & Respiratory Protection</a></li>
