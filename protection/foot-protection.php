...
$page_title = "Foot Protection";
$category_id = "protection";
$subcategory_id = "foot-protection";
...
if (!$current_category) {
    $current_category = array(
        ...
        'description' => 'Professional foot protection equipment for workplace safety.',
        'subcategories' => array()
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Foot Protection';
    $category_description = $current_category['description'] ?? 'Professional foot protection equipment for workplace safety.';
    ?>
...
<body>
    ...
    <div class="category-container">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Foot Protection'); ?></h2>
            ...
            <div class="product-grid">
                ...
                if (!empty($all_products)) {
                    foreach ($all_products as $product) {
                        ...
                        $type = htmlspecialchars($product['type'] ?? 'Safety Equipment');
                ...
                <div class="product-card">
                    ...
                    <button class="add-to-inquiry" type="button" data-model="Foot Protection" data-type="Safety Equipment" data-brand="Industrial">ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
