...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'High-efficiency gas saving regulators designed to reduce gas consumption while maintaining consistent pressure control for cost-effective welding operations',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Gas Saving Regulator';
    $category_description = 'High-efficiency gas saving regulators designed to reduce gas consumption while maintaining consistent pressure control for cost-effective welding operations';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Gas Saving Regulator products
