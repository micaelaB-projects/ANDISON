...
if (!$current_category) {
    $current_category = array(
        ...
        'description' => 'Reliable gas saving regulators designed to reduce gas consumption while maintaining consistent welding performance. Improve cost efficiency without compromising quality.',
        'subcategories' => array()
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Professional gas saving regulators for efficient welding operations.';
    ?>
        ...
        <div class="category-content">
            ...
            <div class="product-grid">
                ...
                <div class="product-card">
                    ...
                    <button class="add-to-inquiry" type="button" data-model="Gas Saving Regulator" data-type="Regulator" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
