...
// Set category and subcategory for Gas Saving Regulator
...
<script>var CATEGORY_NAME = '<?php echo htmlspecialchars($category_name ?? 'Gas Saving Regulator', ENT_QUOTES); ?>';</script>
<script>
