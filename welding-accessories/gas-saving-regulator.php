...
$page_title = "Gas Saving Regulator";
...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Gas Saving Regulator',
        'description' => 'High-efficiency gas saving regulators for cost-effective welding operations.',
        'subcategories' => array(
            array('id' => 'gas-saving-regulator', 'name' => 'Gas Saving Regulator')
        )
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'High-efficiency gas saving regulators for cost-effective welding operations.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch gas saving regulator products
                $all_products = andison_get_products_for_subcategory('welding-accessories', 'gas-saving-regulator');
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Gas Saving Regulator" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
