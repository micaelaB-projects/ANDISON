...
$subcategory_id = "gas-saving-regulator";
...
if (!$current_category) {
    die("Gas Saving Regulator category not found");
}

$page_title = $current_category['name'] ?? "Gas Saving Regulator";
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Gas Saving Regulator';
    $category_description = $current_category['description'] ?? 'Professional gas saving regulators for industrial applications.';
    ?>
...
<!-- Mini Sidebar (Icon Bar) -->
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Gas Saving Regulator'); ?></h2>
            ...
            <div class="product-grid">
                <?php 
                // Dynamically fetch products for Gas Saving Regulator subcategory
                $all_products = array();
                ...
                <div class="product-card">
                    <div class="product-image">
                        <i class="bi bi-speedometer2" style="font-size: 60px; color: #ccc;"></i>
                    </div>
                    <h4>Gas Saving Regulator</h4>
                    <p class="product-type">No products available</p>
                    <button class="add-to-inquiry" type="button" data-model="Gas Saving Regulator" data-type="Gas Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
