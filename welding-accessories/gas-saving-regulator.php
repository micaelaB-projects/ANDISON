...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Efficient gas saving regulators designed to reduce gas consumption while maintaining optimal welding performance. Our regulators provide precise pressure control and improved cost efficiency.',
        'subcategories' => array()
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Efficient gas saving regulators designed to reduce gas consumption while maintaining optimal welding performance. Our regulators provide precise pressure control and improved cost efficiency.';
    ?>
        ...
        <div class="category-content">
            ...
            <div class="product-grid">
                ...
                <div class="product-card">
                    ...
                    <button class="add-to-inquiry" type="button" data-model="Gas Saving Regulator" data-type="Welding Equipment" data-brand="Industrial">ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
