...
<body class="brand-page">
    ...
    <aside id="sidebar" class="sidebar-overlay" aria-hidden="true">
        ...
        <ul class="sidebar-list">
            ...
            <li class="has-sub">
                <a href="./welding-accessories.php"><span class="sidebar-icon" aria-hidden="true"><i class="bi bi-gear"></i></span><span class="sidebar-label">Welding Accessories</span></a>
                ...
                <ul id="sub-welding-accessories" class="sidebar-sublist collapsed">
                    <li><a href="./welding-head-face-protection.php">Welding, Head & Face Protection</a></li>
                </ul>
            </li>
        </ul>
    </aside>
