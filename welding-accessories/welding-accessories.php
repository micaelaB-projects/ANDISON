...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Professional welding accessories and equipment for industrial welding operations.',
        'subcategories' => array(
            array('id' => 'gas-cutting-equipment', 'name' => 'Gas Cutting Equipment'),
            array('id' => 'gas-saving-regulator', 'name' => 'Gas Saving Regulator'),
            array('id' => 'industrial-markers', 'name' => 'Industrial Markers'),
            array('id' => 'measuring-gauge', 'name' => 'Measuring Gauge'),
            array('id' => 'non-destructive-crack-detection', 'name' => 'Non-Destructive Crack Detection'),
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Professional welding accessories and equipment for industrial welding operations.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch welding accessories products from all subcategories
                $subcategories = [
                    'welding-accessories',
                ...
                foreach ($subcategories as $subcat) {
                    $products = andison_get_products_for_subcategory('welding-accessories', $subcat);
                    if (!empty($products)) {
