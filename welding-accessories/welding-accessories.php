...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Comprehensive welding accessories including consumables, tools, equipment, and safety gear for all welding applications',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Welding Accessories';
    $category_description = 'Comprehensive welding accessories including consumables, tools, equipment, and safety gear for all welding applications';
    ?>
    ...
    <!-- Overlay Backdrop --><?php include $_SERVER['DOCUMENT_ROOT'] . '/ANDISON/includes/sidebar.php'; ?>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Welding Accessories products
                $all_products = andison_get_products_for_subcategory('welding-accessories', 'welding-accessories');
