...
if (!$current_category) {
    die("Other Welding Accessories category not found");
}

$page_title = $current_category['name'] ?? "Other Welding Accessories";
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Additional welding accessories and equipment for various applications.';
    ?>
...
<!-- Mini Sidebar (Icon Bar) -->
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Other Welding Accessories'); ?></h2>
            ...
            <div class="product-grid">
                <?php 
                // Dynamically fetch products for Other Welding Accessories subcategory
                $all_products = array();
                ...
                <div class="product-card">
                    <div class="product-image">
                        <i class="bi bi-box-seam" style="font-size: 60px; color: #ccc;"></i>
                    </div>
                    <h4>Other Welding Accessories</h4>
                    <p class="product-type">No products available</p>
                    <button class="add-to-inquiry" type="button" data-model="Welding Accessory" data-type="Welding Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
