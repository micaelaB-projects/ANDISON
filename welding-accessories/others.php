...
$page_title = "Other Welding Accessories";
...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Other Welding Accessories',
        'description' => 'Miscellaneous welding accessories and supplies for industrial applications.',
        'subcategories' => array(
            array('id' => 'others', 'name' => 'Other Welding Accessories')
        )
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Other Welding Accessories';
    $category_description = $current_category['description'] ?? 'Miscellaneous welding accessories and supplies for industrial applications.';
    ?>
                    ...
                    <li>
                        ...
                        <div class="nav-dropdown">
                            ...
                            <ul>
                                ...
                                <li><a href="../brand.php?name=MOTOLITE"><img src="../assets/brands/MOTOLITE.jpg" alt="Motolite" title="Motolite"></a></li>i>
                            </ul>
                        </div>
                    </li>
                    <li>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch other welding accessories products
                $all_products = andison_get_products_for_subcategory('welding-accessories', 'others');
                ...
                if (!empty($all_products)) {
                    foreach ($all_products as $product) {
                        ...
                        $type = htmlspecialchars($product['type'] ?? 'Welding Accessory');
                ...
                <div class="product-card">
                    <div class="product-image">
                        <?php if (!empty($image_src)): ?>
                            <img src="<?php echo $image_src; ?>" alt="<?php echo $name; ?>" onerror="this.parentElement.innerHTML='<i class=&quot;bi bi-gear&quot; style=&quot;font-size: 56px; color: #ccc;&quot;></i>'">
                        <?php else: ?>
                            <i class="bi bi-gear" style="font-size: 56px; color: #ccc;"></i>
                        <?php endif; ?>
                        <?php if (!empty($badge)): ?>
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h4>Other Welding Accessories</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="Other Welding Accessories" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
