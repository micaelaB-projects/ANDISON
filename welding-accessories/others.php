...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Others',
        'description' => 'Miscellaneous welding accessories including protective screens, welding cables, blankets, and specialized protective materials for welding operations',
        'subcategories' => array(
...
<head>
    ...
    $category_description = 'Miscellaneous welding accessories including protective screens, welding cables, blankets, and specialized protective materials for welding operations';
    ?>
            ...
            <div class="main-product-area">
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Others" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
