...
$subcategory_id = "welding-electrode-oven";
...
if (!$current_category) {
    die("Welding Electrode Oven category not found");
}

$page_title = $current_category['name'] ?? "Welding Electrode Oven";
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Welding Electrode Oven';
    $category_description = $current_category['description'] ?? 'Professional welding electrode ovens for industrial applications.';
    ?>
...
<!-- Mini Sidebar (Icon Bar) -->
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        <div class="mini-popover-header">
            <div class="mini-popover-title">Welding Accessories</div>
        </div>
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Welding Electrode Oven'); ?></h2>
            ...
            <div class="product-grid">
                <?php 
                // Dynamically fetch products for Welding Electrode Oven subcategory
                $all_products = array();
                ...
                <div class="product-card">
                    <div class="product-image">
                        <?php if (!empty($image_src)): ?>
                            <img src="<?php echo $image_src; ?>" alt="<?php echo $name; ?>" onerror="this.parentElement.innerHTML='<i class=&quot;bi bi-gear&quot; style=&quot;font-size: 60px; color: #ccc;&quot;></i>'">
                        <?php else: ?>
                            <i class="bi bi-gear" style="font-size: 60px; color: #ccc;"></i>
                        <?php endif; ?>
                        <?php if (!empty($badge)): ?>
                ...
                <div class="product-card">
                    ...
                    <h4>Welding Electrode Oven</h4>
                    <p class="product-type">No products available</p>
                    <button class="add-to-inquiry" type="button" data-model="Welding Electrode Oven" data-type="Welding Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
    ...
    <script>
        ...
        function getPopoverItems(key) {
            ...
            var maps = {
                ...
                'arc-welding-machine': [{label: 'MIG Welding Machine', href: base + '/mig-welding-machine.php'},{label: 'CO1/MAG Welding Machine', href: base + '/co1-mag-welding-machine.php'},{label: 'STUD Welding Machine', href: base + '/stud-welding-machine.php'},{label: 'TIG Welding Machine', href: base + '/tig-welding-machine.php'},{label: 'Plasma Cutting Machine', href: base + '/plasma-cutting-machine.php'}],
                ...
                'welding-accessories': [{label: 'Welding Electrode Oven', href: base + '/welding-electrode-oven.php'},{label: 'Non-Destructive Crack Detection', href: base + '/non-destructive-crack-detection.php'},{label: 'Gas Saving Regulator', href: base + '/gas-saving-regulator.php'},{label: 'Gas Cutting Equipment', href: base + '/gas-cutting-equipment.php'},{label: 'Industrial Markers', href: base + '/industrial-markers.php'},{label: 'Measuring Gauge', href: base + '/measuring-gauge.php'},{label: 'Others', href: base + '/others.php'}],
