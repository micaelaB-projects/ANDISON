...
// Set category and subcategory for Welding Electrode Oven
...
if (!$current_category) {
    $current_category = array(
        ...
        'description' => 'Discover our comprehensive range of welding accessories and equipment solutions for industrial applications.',
        'subcategories' => array(
...
<head>
    ...
    <style>
        * {
        ...
        /* Modal CSS is now in includes/product_modal.php for unified usage */
    </style>
</head>
<body>
...
<script>var CATEGORY_NAME = '<?php echo htmlspecialchars($category_name ?? 'Welding Electrode Oven', ENT_QUOTES); ?>';</script>
<script>
// Set the path to load product details from master welding accessories JSON
var MODAL_JSON_PATH = '/ANDISON/Andison/data/products/welding-accessories/welding-accessories-all.json';
</script>
