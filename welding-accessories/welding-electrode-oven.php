...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Specialized electrode heating and storage systems for maintaining electrode moisture and temperature for optimal welding performance',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Welding Electrode Oven';
    $category_description = 'Specialized electrode heating and storage systems for maintaining electrode moisture and temperature for optimal welding performance';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Welding Electrode Oven products
