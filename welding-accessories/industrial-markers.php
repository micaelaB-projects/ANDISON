...
$subcategory_id = "industrial-markers";
...
if (!$current_category) {
    die("Industrial Markers category not found");
}

$page_title = $current_category['name'] ?? "Industrial Markers";
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Industrial Markers';
    $category_description = $current_category['description'] ?? 'Professional industrial marking solutions for welding and fabrication.';
    ?>
...
<!-- Mini Sidebar (Icon Bar) -->
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Industrial Markers'); ?></h2>
            ...
            <div class="product-grid">
                <?php 
                // Dynamically fetch products for Industrial Markers subcategory
                $all_products = array();
                ...
                <div class="product-card">
                    <div class="product-image">
                        <i class="bi bi-pen" style="font-size: 60px; color: #ccc;"></i>
                    </div>
                    <h4>Industrial Markers</h4>
                    <p class="product-type">No products available</p>
                    <button class="add-to-inquiry" type="button" data-model="Industrial Marker" data-type="Marking Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
