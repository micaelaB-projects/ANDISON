...
if (!$current_category) {
    $current_category = array(
        ...
        'description' => 'High-quality industrial markers for marking, labeling, and identification in welding and fabrication environments. Durable and reliable performance.',
        'subcategories' => array()
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'High-quality industrial markers for marking, labeling, and identification in welding and fabrication environments. Durable and reliable performance.';
    ?>
        ...
        <div class="category-content">
            ...
            <div class="product-grid">
                ...
                <div class="product-card">
                    ...
                    <button class="add-to-inquiry" type="button" data-model="Industrial Markers" data-type="Welding Equipment" data-brand="Industrial">ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
