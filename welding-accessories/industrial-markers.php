...
if (!$current_category) {
    $current_category = array(
        ...
        'description' => 'Reliable industrial markers and marking tools for identifying and labeling welded components. Essential for quality control and traceability in industrial operations.',
        'subcategories' => array()
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Professional industrial marking and identification products.';
    ?>
        ...
        <div class="category-content">
            ...
            <div class="product-grid">
                ...
                <div class="product-card">
                    ...
                    <button class="add-to-inquiry" type="button" data-model="Industrial Markers" data-type="Markers" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
