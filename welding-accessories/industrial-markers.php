...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Temperature-indicating and industrial marking solutions for welding and metalworking.',
        'subcategories' => array(
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Temperature-indicating and industrial marking solutions for welding and metalworking.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch industrial markers products
                $all_products = andison_get_products_for_subcategory('welding-accessories', 'industrial-markers');
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Industrial Markers" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
