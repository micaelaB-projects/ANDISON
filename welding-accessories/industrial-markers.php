...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Professional industrial markers and temperature-indicating tools for identification, labeling, and quality control in welding and manufacturing applications',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Industrial Markers';
    $category_description = 'Professional industrial markers and temperature-indicating tools for identification, labeling, and quality control in welding and manufacturing applications';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Industrial Markers products
