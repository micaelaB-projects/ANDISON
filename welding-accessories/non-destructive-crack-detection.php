...
// Set category and subcategory for Non-Destructive Crack Detection
...
<script>var CATEGORY_NAME = '<?php echo htmlspecialchars($category_name ?? 'Non-Destructive Crack Detection', ENT_QUOTES); ?>';</script>
<script>
