...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Advanced non-destructive testing equipment for detecting cracks, defects, and flaws in welded components through magnetic particle inspection and ultrasonic technology',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Non-Destructive Crack Detection';
    $category_description = 'Advanced non-destructive testing equipment for detecting cracks, defects, and flaws in welded components through magnetic particle inspection and ultrasonic technology';
    ?>
...
<body>
    ...
    <header>
        ...
        <div class="category-content">
            <h2>Non-Destructive Crack Detection</h2>
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Non-Destructive Crack Detection products
