...
if (!$current_category) {
    $current_category = array(
        ...
        'description' => 'Professional gas cutting equipment and machines for precision cutting operations. Our line features reliable gas cutting tools for industrial applications.',
        'subcategories' => array()
    );
}
?>
