...
if (!$current_category) {
    $current_category = array(
        ...
        'description' => 'Professional gas cutting equipment designed for precision cutting applications. Our tools deliver clean, accurate cuts for various welding and fabrication tasks.',
        'subcategories' => array()
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Professional gas cutting equipment designed for precision cutting applications. Our tools deliver clean, accurate cuts for various welding and fabrication tasks.';
    ?>
        ...
        <div class="category-content">
            ...
            <div class="product-grid">
                ...
                <div class="product-card">
                    ...
                    <button class="add-to-inquiry" type="button" data-model="Gas Cutting Equipment" data-type="Welding Equipment" data-brand="Industrial">ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
