...
// Set category and subcategory for Gas Cutting Equipment
...
<script>var CATEGORY_NAME = '<?php echo htmlspecialchars($category_name ?? 'Gas Cutting Equipment', ENT_QUOTES); ?>';</script>
<script>
