...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Professional gas cutting equipment and tools for precision cutting operations',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Gas Cutting Equipment';
    $category_description = 'Professional gas cutting equipment and tools for precision cutting operations';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Gas Cutting Equipment products
