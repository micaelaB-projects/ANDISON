...
$page_title = "Gas Cutting Equipment";
...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Gas Cutting Equipment',
        'description' => 'Professional gas cutting equipment for precise industrial cutting operations.',
        'subcategories' => array(
            array('id' => 'gas-cutting-equipment', 'name' => 'Gas Cutting Equipment')
        )
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Professional gas cutting equipment for precise industrial cutting operations.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch gas cutting equipment products
                $all_products = andison_get_products_for_subcategory('welding-accessories', 'gas-cutting-equipment');
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Gas Cutting Equipment" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
