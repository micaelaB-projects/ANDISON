...
$subcategory_id = "gas-cutting-equipment";
...
if (!$current_category) {
    die("Gas Cutting Equipment category not found");
}

$page_title = $current_category['name'] ?? "Gas Cutting Equipment";
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Gas Cutting Equipment';
    $category_description = $current_category['description'] ?? 'Professional gas cutting equipment for industrial applications.';
    ?>
...
<!-- Mini Sidebar (Icon Bar) -->
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Gas Cutting Equipment'); ?></h2>
            ...
            <div class="product-grid">
                <?php 
                // Dynamically fetch products for Gas Cutting Equipment subcategory
                $all_products = array();
                ...
                <div class="product-card">
                    <div class="product-image">
                        <i class="bi bi-fire" style="font-size: 60px; color: #ccc;"></i>
                    </div>
                    <h4>Gas Cutting Equipment</h4>
                    <p class="product-type">No products available</p>
                    <button class="add-to-inquiry" type="button" data-model="Gas Cutting Equipment" data-type="Gas Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
