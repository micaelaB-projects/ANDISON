...
$subcategory_id = "welding-head-face-protection";
...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $subcategory_id,
        'name' => 'Welding, Head & Face Protection',
        'description' => 'Specialized protection for welding, head, and face safety.',
        'subcategories' => array()
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Specialized protection for welding, head, and face safety.';
    ?>
...
<body>
    ...
    <header>
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Welding, Head & Face Protection'); ?></h2>
