...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Precision measuring gauges and temperature monitoring tools for accurate measurements and thermal control in welding and fabrication operations',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Measuring Gauge';
    $category_description = 'Precision measuring gauges and temperature monitoring tools for accurate measurements and thermal control in welding and fabrication operations';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Measuring Gauge products
