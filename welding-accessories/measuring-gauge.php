...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Measuring Gauge',
        'description' => 'Precision measuring gauges for welding and thermal monitoring applications.',
        'subcategories' => array(
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Precision measuring gauges for welding and thermal monitoring applications.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch measuring gauge products
                $all_products = andison_get_products_for_subcategory('welding-accessories', 'measuring-gauge');
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Measuring Gauge" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
