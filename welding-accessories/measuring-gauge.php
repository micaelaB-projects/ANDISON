...
if (!$current_category) {
    $current_category = array(
        ...
        'description' => 'Precision measuring gauges and instruments for accurate measurements in welding and fabrication work. Ensure quality and consistency with our reliable measurement tools.',
        'subcategories' => array()
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Precision measuring gauges and instruments for accurate measurements in welding and fabrication work. Ensure quality and consistency with our reliable measurement tools.';
    ?>
