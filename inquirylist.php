...
<body>
    ...
    <script>
        // Sync page-content padding with sidebar expand/collapse state
        (function() {
            var pageContent = document.querySelector('.page-content');
            var miniSidebar = document.getElementById('miniSidebar');
            
            if (!pageContent || !miniSidebar) return;
            
            // Check sidebar state and update page-content accordingly
            function syncSidebarState() {
                if (miniSidebar.classList.contains('expanded')) {
                    pageContent.classList.add('sidebar-expanded');
                } else {
                    pageContent.classList.remove('sidebar-expanded');
                }
            }
            ...
            observer.observe(miniSidebar, { attributes: true, attributeFilter: ['class'] });
