...
if (!$current_category) {
    die("V-Line Series category not found");
}

$page_title = $current_category['name'] ?? "V-Line Series";
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Professional V-Line series drilling equipment for industrial applications.';
    ?>
...
<body>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'V-Line Series'); ?></h2>
            ...
            <div class="product-grid">
                <?php 
                // Dynamically fetch products for V-Line Series subcategory
                $all_products = array();
                ...
                <div class="product-card">
                    ...
                    <h4>V-Line Series Equipment</h4>
                    <p class="product-type">No products available</p>
                    <button class="add-to-inquiry" type="button" data-model="V-Line Series" data-type="V-Line Series Equipment" data-brand="Industrial">ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
