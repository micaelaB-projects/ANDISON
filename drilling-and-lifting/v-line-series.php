...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'V-Line Series',
        'description' => 'Low-profile V-Line Series magnetic base core drills for versatile and specialized drilling applications',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'V-Line Series';
    $category_description = 'Low-profile V-Line Series magnetic base core drills for versatile and specialized drilling applications';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only V-Line Series products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="V-Line Series" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
