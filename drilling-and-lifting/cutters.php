...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Core Cutters',
        'description' => 'Professional annular cutters and drilling accessories for precision hole cutting applications',
        'subcategories' => array(
            array('id' => 'cutters', 'name' => 'Core Cutters')
        )
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = 'Core Cutters';
    $category_description = 'Professional annular cutters and drilling accessories for precision hole cutting applications';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Core Cutters products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Core Cutters" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
