...
if (!$current_category) {
    die("Lifting category not found");
}

$page_title = $current_category['name'] ?? "Lifting";
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Lifting';
    $category_description = $current_category['description'] ?? 'Professional lifting equipment for industrial applications.';
    ?>
        ...
        <div class="category-content">
            ...
            <div class="product-grid">
                ...
                <div class="product-card">
                    ...
                    <button class="add-to-inquiry" type="button" data-model="Lifting Equipment" data-type="Lifting Equipment" data-brand="Industrial">ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
