...
$current_category['name'] = 'Lifting';
$current_category['description'] = 'Professional lifting equipment and solutions for safe material handling.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    $category_description = $current_category['description'] ?? 'Professional lifting equipment and solutions for safe material handling.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch lifting products
                $all_products = andison_get_products_for_subcategory('drilling-and-lifting', 'lifting');
                ...
                if (!empty($all_products)) {
                    foreach ($all_products as $product) {
                        ...
                        $type = htmlspecialchars($product['type'] ?? 'Lifting Equipment');
                ...
                <div class="product-card">
                    <div class="product-image">
                        <?php if (!empty($image_src)): ?>
                            <img src="<?php echo $image_src; ?>" alt="<?php echo $name; ?>" onerror="this.parentElement.innerHTML='<i class=&quot;bi bi-droplet-half&quot; style=&quot;font-size: 56px; color: #ccc;&quot;></i>'">
                        <?php else: ?>
                            <i class="bi bi-droplet-half" style="font-size: 56px; color: #ccc;"></i>
                        <?php endif; ?>
                        <?php if (!empty($badge)): ?>
