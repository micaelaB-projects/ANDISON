...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Lifting',
        'description' => 'Professional lifting magnets and slings for safe and efficient material handling',
        'subcategories' => array(
...
<head>
    ...
    $category_description = 'Professional lifting magnets and slings for safe and efficient material handling';
    ?>
            ...
            <div class="main-product-area">
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Lifting" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
