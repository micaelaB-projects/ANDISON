...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'RBX-Line Series',
        'description' => 'Heavy-duty RBX-Line Series magnetic base core drills for industrial drilling applications',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'RBX-Line Series';
    $category_description = 'Heavy-duty RBX-Line Series magnetic base core drills for industrial drilling applications';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only RBX-Line Series products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h4>RBX-Line Series</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="RBX-Line Series" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
