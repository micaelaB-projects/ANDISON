...
$page_title = "RBX Line Series";
$category_id = "drilling-and-lifting";
$subcategory_id = "rbx-line-series";
...
$current_category['name'] = 'RBX Line Series';
$current_category['description'] = 'Alfra Rotabest RBX-Line heavy-duty magnetic base core drills.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'RBX Line Series';
    $category_description = $current_category['description'] ?? 'Alfra Rotabest RBX-Line heavy-duty magnetic base core drills.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch RBX Line Series products
                $all_products = andison_get_products_for_subcategory('drilling-and-lifting', 'rbx-line-series');
