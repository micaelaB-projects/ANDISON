...
if (!$current_category) {
    die("RBX - LINE SERIES category not found");
}

$page_title = $current_category['name'] ?? "RBX - LINE SERIES";
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Professional RBX - LINE SERIES drilling equipment for industrial applications.';
    ?>
...
<body>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'RBX - LINE SERIES'); ?></h2>
            ...
            <div class="product-grid">
                <?php 
                // Dynamically fetch products for RBX - LINE SERIES subcategory
                $all_products = array();
                ...
                <div class="product-card">
                    ...
                    <h4>RBX - LINE SERIES Equipment</h4>
                    <p class="product-type">No products available</p>
                    <button class="add-to-inquiry" type="button" data-model="RBX - LINE SERIES" data-type="RBX - LINE SERIES Equipment" data-brand="Industrial">ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
