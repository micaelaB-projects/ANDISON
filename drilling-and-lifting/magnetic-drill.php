...
$current_category['name'] = 'Magnetic Drill';
$current_category['description'] = 'Professional magnetic drilling equipment for precision metalworking applications.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    $category_description = $current_category['description'] ?? 'Professional magnetic drilling equipment for precision metalworking applications.';
    ?>
    ...
    <aside id="sidebar" class="sidebar-overlay" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch magnetic drill products
                $all_products = andison_get_products_for_subcategory('drilling-and-lifting', 'magnetic-drill');
