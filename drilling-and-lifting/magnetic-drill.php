...
if (!$current_category) {
    die("Magnetic Drill category not found");
}

$page_title = $current_category['name'] ?? "Magnetic Drill";
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Magnetic Drill';
    $category_description = $current_category['description'] ?? 'Professional magnetic drill equipment for industrial applications.';
    ?>
        ...
        <div class="category-content">
            ...
            <div class="product-grid">
                ...
                <div class="product-card">
                    ...
                    <h4>Magnetic Drill Equipment</h4>
                    <p class="product-type">No products available</p>
                    <button class="add-to-inquiry" type="button" data-model="Magnetic Drill" data-type="Magnetic Drill" data-brand="Industrial">ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
