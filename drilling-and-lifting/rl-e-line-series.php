...
if (!$current_category) {
    die("RL - E - Line Series category not found");
}

$page_title = $current_category['name'] ?? "RL - E - Line Series";
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Professional RL - E - Line series drilling equipment for industrial applications.';
    ?>
...
<body>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'RL - E - Line Series'); ?></h2>
            ...
            <div class="product-grid">
                <?php 
                // Dynamically fetch products for RL - E - Line Series subcategory
                $all_products = array();
                ...
                <div class="product-card">
                    ...
                    <h4>RL - E - Line Series Equipment</h4>
                    <p class="product-type">No products available</p>
                    <button class="add-to-inquiry" type="button" data-model="RL - E - Line Series" data-type="RL - E - Line Series Equipment" data-brand="Industrial">ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
