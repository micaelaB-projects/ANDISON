...
$page_title = "RL-E Line Series";
$category_id = "drilling-and-lifting";
$subcategory_id = "rl-e-line-series";
...
$current_category['name'] = 'RL-E Line Series';
$current_category['description'] = 'Alfra Rotabest RL-E-Line precision magnetic base core drills.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'RL-E Line Series';
    $category_description = $current_category['description'] ?? 'Alfra Rotabest RL-E-Line precision magnetic base core drills.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch RL-E Line Series products
                $all_products = andison_get_products_for_subcategory('drilling-and-lifting', 'rl-e-line-series');
