...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'RL-E-Line Series',
        'description' => 'Precision RL-E-Line Series magnetic base core drills for professional drilling applications',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'RL-E-Line Series';
    $category_description = 'Precision RL-E-Line Series magnetic base core drills for professional drilling applications';
    ?>
    ...
    <!-- Overlay Backdrop --><?php include $_SERVER['DOCUMENT_ROOT'] . '/ANDISON/includes/sidebar.php'; ?>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only RL-E-Line Series products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h4>RL-E-Line Series</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="RL-E-Line Series" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
