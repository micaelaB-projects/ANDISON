...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'SP-Line Series',
        'description' => 'Professional SP-Line Series magnetic base core drills with direct Weldon shank for specialized drilling applications',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'SP-Line Series';
    $category_description = 'Professional SP-Line Series magnetic base core drills with direct Weldon shank for specialized drilling applications';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only SP-Line Series products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h4>SP-Line Series</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="SP-Line Series" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
