...
$page_title = "SP Line Series";
$category_id = "drilling-and-lifting";
$subcategory_id = "sp-line-series";
...
$current_category['name'] = 'SP Line Series';
$current_category['description'] = 'Alfra Rotabest SP-Line magnetic base core drills with direct Weldon shank.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'SP Line Series';
    $category_description = $current_category['description'] ?? 'Alfra Rotabest SP-Line magnetic base core drills with direct Weldon shank.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch SP Line Series products
                $all_products = andison_get_products_for_subcategory('drilling-and-lifting', 'sp-line-series');
