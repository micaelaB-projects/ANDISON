...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Comprehensive drilling and lifting solutions for industrial applications',
        'subcategories' => array(
            array('id' => 'drilling-and-lifting', 'name' => 'Drilling and Lifting')
        )
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = 'Drilling and Lifting';
    $category_description = 'Comprehensive drilling and lifting solutions for industrial applications';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Drilling and Lifting products
                $all_products = andison_get_products_for_subcategory('drilling-and-lifting', 'drilling-and-lifting');
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Drilling and Lifting" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
