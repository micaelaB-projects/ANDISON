...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Drilling and Lifting',
        'description' => 'Discover our comprehensive range of drilling and lifting equipment for industrial applications.',
        'subcategories' => array(
            array('id' => 'magnetic-drill', 'name' => 'Magnetic Drill'),
            array('id' => 'lifting', 'name' => 'Lifting'),
            array('id' => 'cutters', 'name' => 'Cutters'),
            array('id' => 'b-line-series', 'name' => 'B Line Series'),
            array('id' => 'v-line-series', 'name' => 'V Line Series'),
            array('id' => 'sp-line-series', 'name' => 'SP Line Series'),
            array('id' => 'rl-e-line-series', 'name' => 'RL-E Line Series'),
            array('id' => 'rbx-line-series', 'name' => 'RBX Line Series')
        )
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Drilling and Lifting';
    $category_description = $current_category['description'] ?? 'Discover our comprehensive range of drilling and lifting equipment for industrial applications.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch drilling and lifting products from all subcategories
                $subcategories = [
                    'magnetic-drill',
                    'lifting',
                    'cutters',
                ...
                foreach ($subcategories as $subcat) {
                    $products = andison_get_products_for_subcategory('drilling-and-lifting', $subcat);
                    if (!empty($products)) {
                ...
                <div class="product-card">
                    <div class="product-image">
                        <?php if (!empty($image_src)): ?>
                            <img src="<?php echo $image_src; ?>" alt="<?php echo $name; ?>" onerror="this.parentElement.innerHTML='<i class=&quot;bi bi-gear-wide-connected&quot; style=&quot;font-size: 56px; color: #ccc;&quot;></i>'">
                        <?php else: ?>
