...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Baterries';
    $category_description = $current_category['description'] ?? 'Explore our comprehensive range of Batteries';
    $phone = "+1(234) 567 8900";
    $phone2 = "+1(234) 567 8900";
    $phone3 = "+1(639) 977 803 7398";
    $email = "info@andison-industrial.com";
...
<body>
    ...
    <div class="mini-sidebar active" id="miniSidebar">
        ...
        <div class="mini-sidebar-icon active-icon has-sub" data-target="../drilling-and-lifting/drilling-and-lifting.php" title="Drilling and Lifting"><i class="bi bi-hammer"></i><span class="label">Drilling and Lifting</span><span class="sub-indicator"><i class="bi bi-chevron-right"></i></span></div>
    ...
    <script>
        ...
        <script>
            ...
            document.addEventListener('click', function(e){
                ...
                window.location.href = '../drilling-and-lifting/drilling-and-lifting.php';
            });
        </script>
    </body>
    </html>
