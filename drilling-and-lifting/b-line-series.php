...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'B-Line Series',
        'description' => 'Professional B-Line Series magnetic base core drills for precision industrial drilling applications',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'B-Line Series';
    $category_description = 'Professional B-Line Series magnetic base core drills for precision industrial drilling applications';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only B-Line Series products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="B-Line Series" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
