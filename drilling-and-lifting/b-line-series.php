...
$current_category['name'] = 'B Line Series';
$current_category['description'] = 'Alfra Rotabest B-Line magnetic base core drills for professional drilling.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    $category_description = $current_category['description'] ?? 'Alfra Rotabest B-Line magnetic base core drills for professional drilling.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch B Line Series products
                $all_products = andison_get_products_for_subcategory('drilling-and-lifting', 'b-line-series');
