...
<div class="grid">
    ...
    <section class="card" style="grid-column:span 6;">
        <h2 style="font-size:18px;margin-bottom:16px;"><i class="bi bi-building"></i> Brand Views</h2>
    ...
    <!-- ── Category Analytics ────────────────────────────────────── -->
    <section class="card" style="grid-column:span 6;">
        <h2 style="font-size:18px;margin-bottom:16px;"><i class="bi bi-tag"></i> Category Views</h2>
