...
$current_category['name'] = 'Multi Gas Detector';
$current_category['description'] = 'Advanced multi-gas detection for comprehensive monitoring.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    $category_description = $current_category['description'] ?? 'Advanced multi-gas detection for comprehensive monitoring.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch multi gas detector products
