...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Advanced multi-gas detectors for monitoring multiple hazardous gases simultaneously',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Multi Gas Detector';
    $category_description = 'Advanced multi-gas detectors for monitoring multiple hazardous gases simultaneously';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Multi Gas Detector products
                $all_products = andison_get_products_for_subcategory('gas-detectors', 'multi-gas-detector');
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Multi Gas Detector" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
