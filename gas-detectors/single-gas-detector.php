...
$current_category['name'] = 'Single Gas Detector';
$current_category['description'] = 'Portable single gas detectors for personal protection.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    $category_description = $current_category['description'] ?? 'Portable single gas detectors for personal protection.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch single gas detector products
