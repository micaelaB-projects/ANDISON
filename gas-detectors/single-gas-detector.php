...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Portable single gas detectors for personal protection and point source monitoring',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Single Gas Detector';
    $category_description = 'Portable single gas detectors for personal protection and point source monitoring';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Single Gas Detector products
                $all_products = andison_get_products_for_subcategory('gas-detectors', 'single-gas-detector');
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Single Gas Detector" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
