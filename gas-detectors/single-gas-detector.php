...
$page_title = "Single-Gas Detector";
$category_id = "gas-detectors";
$subcategory_id = "single-gas-detector";
...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Reliable single-gas detection systems for targeted safety monitoring.',
        'subcategories' => array()
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Single-Gas Detector';
    $category_description = $current_category['description'] ?? 'Reliable single-gas detection systems for targeted safety monitoring.';
    ?>
...
<body>
    ...
    <div class="category-container">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Single-Gas Detector'); ?></h2>
