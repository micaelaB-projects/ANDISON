...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Portable single gas detection systems for safety monitoring.',
        'subcategories' => array()
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Portable single gas detection systems for safety monitoring.';
    ?>
