...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Portable and transportable gas detection solutions for field monitoring and area surveys',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Portable Gas Detectors';
    $category_description = 'Portable and transportable gas detection solutions for field monitoring and area surveys';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Portable Gas Detectors products
                $all_products = andison_get_products_for_subcategory('gas-detectors', 'portable-gas-detectors');
