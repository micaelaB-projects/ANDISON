...
$current_category['name'] = 'Portable Gas Detectors';
$current_category['description'] = 'Portable gas detection systems for mobile monitoring.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    $category_description = $current_category['description'] ?? 'Portable gas detection systems for mobile monitoring.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch portable gas detectors products
