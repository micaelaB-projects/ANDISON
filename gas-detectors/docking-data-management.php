...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Professional docking stations and data management systems for gas detector calibration and monitoring',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Docking Data Management';
    $category_description = 'Professional docking stations and data management systems for gas detector calibration and monitoring';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Docking Data Management products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Docking Data Management" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
