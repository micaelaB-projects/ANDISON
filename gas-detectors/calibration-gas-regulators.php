...
// Set category and subcategory for Calibration Gas Regulators
...
if (!$current_category) {
    $current_category = array(
        'id' => $category_id,
        'name' => 'Gas Detectors',
        'description' => 'Discover our comprehensive range of gas detection products for industrial applications.',
        'subcategories' => array(
