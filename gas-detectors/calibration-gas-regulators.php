...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Calibration Gas Regulators',
        'description' => 'Precision calibration gas and regulators for accurate gas detector calibration',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Calibration Gas Regulators';
    $category_description = 'Precision calibration gas and regulators for accurate gas detector calibration';
    ?>
...
<body>
    ...
    <header>
        ...
        <div class="category-content">
            <h2>Calibration Gas Regulators</h2>
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Calibration Gas Regulators products
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h4>Calibration Gas Regulators</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="Calibration Gas Regulators" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
