...
$page_title = "Calibration Gas Regulators";
...
$current_category['name'] = 'Calibration Gas Regulators';
$current_category['description'] = 'Calibration gas and regulators for gas detector maintenance.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Calibration Gas Regulators';
    $category_description = $current_category['description'] ?? 'Calibration gas and regulators for gas detector maintenance.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch calibration gas regulators products
                $all_products = andison_get_products_for_subcategory('gas-detectors', 'calibration-gas-regulators');
                ...
                if (!empty($all_products)) {
                    foreach ($all_products as $product) {
                        ...
                        $type = htmlspecialchars($product['type'] ?? 'Calibration Equipment');
