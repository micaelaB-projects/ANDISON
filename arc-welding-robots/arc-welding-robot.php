...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Advanced robotic welding systems for industrial automation and precision applications.',
        'subcategories' => array(
...
<head>
    ...
    $category_description = 'Advanced robotic welding systems for industrial automation and precision applications.';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Arc Welding Robot products
                $all_products = andison_get_products_for_subcategory('arc-welding-robots', 'arc-welding-robot');
