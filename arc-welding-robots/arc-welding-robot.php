...
$page_title = "Arc Welding Robot";
$category_id = "arc-welding-robots";
$subcategory_id = "arc-welding-robot";
...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Arc Welding Robot',
        'description' => 'Discover our comprehensive range of arc welding robots for industrial applications.',
        'subcategories' => array(
            array('id' => 'arc-welding-robot', 'name' => 'Arc Welding Robot')
        )
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = 'Arc Welding Robot';
    $category_description = 'Discover our comprehensive range of arc welding robots for industrial applications.';
    ?>
...
<script>var CATEGORY_NAME = '<?php echo htmlspecialchars($category_name ?? 'Arc Welding Robot', ENT_QUOTES); ?>';</script>
