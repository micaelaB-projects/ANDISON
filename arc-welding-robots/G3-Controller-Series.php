...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Advanced G3 controller series featuring compact and efficient technology for robotic welding applications.',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'G3 Controller Series';
    $category_description = 'Advanced G3 controller series featuring compact and efficient technology for robotic welding applications.';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only G3 Controller Series products
