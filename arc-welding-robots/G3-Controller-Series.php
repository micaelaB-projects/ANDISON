...
$page_title = "G3 Controller Series";
$subcategory_id = "g3-controller-series";
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'G3 Controller Series';
    $category_description = $current_category['description'] ?? 'Explore our G3 Controller Series welding robots for advanced robotic welding applications.';
    $phone = "+1(234) 567 8900";
    $phone2 = "+1(234) 567 8900";
    $phone3 = "+1(639) 977 803 7398";
    $email = "info@andison-industrial.com";
...
<body>
    ...
    <div class="category-container">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'G3 Controller Series'); ?></h2>
            ...
            <div class="product-grid">
                ...
                $products = andison_get_products_for_subcategory('arc-welding-robots', 'g3-controller-series');
                ...
                if (!empty($products)) {
                    foreach ($products as $product) {
                        ...
                        $type = htmlspecialchars($product['type'] ?? 'G3 Controller Series');
