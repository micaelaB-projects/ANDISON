...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Discover our comprehensive range of G3 controller series for arc welding robots and industrial applications.',
        'subcategories' => array(
...
<head>
    ...
    $category_description = 'Discover our comprehensive range of G3 controller series for arc welding robots and industrial applications.';
    ?>
    ...
    <header>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch G3 controller series products
...
<script>var CATEGORY_NAME = '<?php echo htmlspecialchars($category_name ?? 'G3 Controller Series', ENT_QUOTES); ?>';</script>
