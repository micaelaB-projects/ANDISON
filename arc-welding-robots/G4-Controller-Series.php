...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Next-generation G4 controller series with advanced features for modern industrial welding automation.',
        'subcategories' => array(
...
<head>
    ...
    $category_description = 'Next-generation G4 controller series with advanced features for modern industrial welding automation.';
    ?>
    ...
    <!-- Overlay Backdrop --><?php include $_SERVER['DOCUMENT_ROOT'] . '/ANDISON/includes/sidebar.php'; ?>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only G4 Controller Series products
