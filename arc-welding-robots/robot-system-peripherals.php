...
if ($current_category) {
    $current_category['name'] = 'Robot System Peripherals';
    $current_category['description'] = 'Explore our comprehensive range of peripheral equipment and accessories designed to enhance your robotic welding systems.';
}
...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Explore our comprehensive range of peripheral equipment and accessories designed to enhance your robotic welding systems.',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Robot System Peripherals';
    $category_description = $current_category['description'] ?? 'Explore our comprehensive range of peripheral equipment and accessories designed to enhance your robotic welding systems.';
    ?>
...
<body>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Robot System Peripherals'); ?></h2>
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch robot system peripherals
                $all_products = andison_get_products_for_subcategory('arc-welding-robots', 'robot-system-peripherals');
                ...
                <div class="product-card">
                    <div class="product-image">
                        <i class="bi bi-gear-wide-connected" style="font-size: 56px; color: #ccc;"></i>
                    </div>
                    <div class="product-info">
                        <h4>Robot System Peripherals</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="Robot System Peripherals" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
