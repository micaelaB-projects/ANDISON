...
if (!$current_category) {
    $current_category = array(
        ...
        'description' => 'Complete range of robot system peripherals and accessories for arc welding robot installations.',
        'subcategories' => array()
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Robot system peripherals and accessories.';
    ?>
