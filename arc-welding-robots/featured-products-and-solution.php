...
if ($current_category) {
    $current_category['name'] = 'Featured Products and Solutions';
    $current_category['description'] = 'Discover our featured robotic welding solutions and innovative products designed for professional applications.';
}
...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Discover our featured robotic welding solutions and innovative products designed for professional applications.',
        'subcategories' => array(
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Discover our featured robotic welding solutions and innovative products designed for professional applications.';
    ?>
...
<body>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Featured Products and Solutions'); ?></h2>
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch featured products and solutions
                $all_products = andison_get_products_for_subcategory('arc-welding-robots', 'featured-products-and-solution');
                ...
                <div class="product-card">
                    <div class="product-image">
                        <i class="bi bi-stars" style="font-size: 56px; color: #ccc;"></i>
                    </div>
                    <div class="product-info">
                        <h4>Featured Products and Solutions</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="Featured Products and Solutions" data-type="Equipment" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
