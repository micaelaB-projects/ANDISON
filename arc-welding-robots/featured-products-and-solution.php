...
$page_title = "Featured Products and Solution";
...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Featured Products and Solution',
        'description' => 'Discover our comprehensive range of featured products and solutions for arc welding robots and industrial applications.',
        'subcategories' => array(
            array('id' => 'featured-products-and-solution', 'name' => 'Featured Products and Solution')
        )
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = 'Featured Products and Solution';
    $category_description = 'Discover our comprehensive range of featured products and solutions for arc welding robots and industrial applications.';
    ?>
...
<body>
    ...
    <header>
        ...
        <div class="category-content">
            <h2>Featured Products and Solution</h2>
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch featured products and solution products
...
<script>var CATEGORY_NAME = '<?php echo htmlspecialchars($category_name ?? 'Featured Products', ENT_QUOTES); ?>';</script>
