...
$subcategory_id = "welding-consumables";
...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Essential welding consumables including electrodes, filler materials, gas cylinders, and protective consumables for various welding processes',
        'subcategories' => array(
            array('id' => 'welding-consumables', 'name' => 'Welding Consumables')
        )
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = 'Welding Consumables';
    $category_description = 'Essential welding consumables including electrodes, filler materials, gas cylinders, and protective consumables for various welding processes';
    ?>
    ...
    <!-- Overlay Backdrop --><?php include $_SERVER['DOCUMENT_ROOT'] . '/ANDISON/includes/sidebar.php'; ?>
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch only Welding Consumables products
                $all_products = andison_get_products_for_subcategory('welding-consumables', 'welding-consumables');
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Welding Consumables" data-type="Consumables" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
