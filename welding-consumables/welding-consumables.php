...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'High-quality welding consumables including electrodes, wires, and accessories for professional welding applications.',
        'subcategories' => array()
    );
}
?>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'High-quality welding consumables for professional applications.';
    ?>
            ...
            <ul>
                ...
                <li>
                    ...
                    <div class="nav-dropdown">
                        <h4>About ANDISON</h4>
                        <ul>
                            <li><a href="../aboutus.php#who-we-are">Who We Are</a></li>
                            <li><a href="../aboutus.php#our-mission">Our Mission</a></li>
        ...
        <ul class="sidebar-list">
            ...
            <li class="has-sub">
                ...
                <ul id="sub-power-tool" class="sidebar-sublist collapsed">
                    ...
                    <li><a href="../power-tools/accessories/accessories.php">Power Tools Accessories</a></li>
                </ul>
            </li>
            <li class="has-sub">
            ...
            <li class="has-sub active">
                <a href="welding-consumables.php"><span class="sidebar-icon" aria-hidden="true"><i class="bi bi-box"></i></span><span class="sidebar-label">Welding Consumables</span></a>
            </li>
        </ul>
    </aside>
