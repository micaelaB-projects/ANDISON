...
// Set category and subcategory for Welding Consumables
...
if (!$current_category) {
    $current_category = array(
        ...
        'description' => 'Discover our comprehensive range of welding consumables and supplies for industrial applications.',
        'subcategories' => array(
...
<script>var CATEGORY_NAME = '<?php echo htmlspecialchars($category_name ?? 'Welding Consumables', ENT_QUOTES); ?>';</script>
<script>
