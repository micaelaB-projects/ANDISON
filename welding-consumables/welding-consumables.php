...
$page_title = "Welding Consumables";
...
if (!$current_category) {
    ...
    $current_category = array(
        ...
        'description' => 'Explore our comprehensive range of welding consumables from leading brands for all welding applications.',
        'subcategories' => array(
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Explore our comprehensive range of welding consumables from leading brands for all welding applications.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch welding consumable products from all brands
                $subcategories = [
                    'kobelco',
                    'metrode'
                ];
                ...
                foreach ($subcategories as $subcat) {
                    $products = andison_get_products_for_subcategory('welding-consumables', $subcat);
                    if (!empty($products)) {
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Welding Consumables" data-type="Welding Consumable" data-brand="Industrial" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
