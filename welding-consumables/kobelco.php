...
$page_title = "Kobelco Welding Consumables";
...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Kobelco',
        'description' => 'Premium Kobelco welding consumables including electrodes, wires, and fluxes for industrial applications.',
        'subcategories' => array(
            array('id' => 'kobelco', 'name' => 'Kobelco')
        )
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Kobelco Welding Consumables';
    $category_description = $current_category['description'] ?? 'Premium Kobelco welding consumables including electrodes, wires, and fluxes for industrial applications.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch Kobelco welding consumable products
                $all_products = andison_get_products_for_subcategory('welding-consumables', 'kobelco');
                ...
                if (!empty($all_products)) {
                    foreach ($all_products as $product) {
                        ...
                        $brand = htmlspecialchars($product['brand'] ?? 'Kobelco');
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h4>Kobelco Products</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="Kobelco" data-type="Welding Consumable" data-brand="Kobelco" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
