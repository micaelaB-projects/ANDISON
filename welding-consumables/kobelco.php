...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Kobelco',
        'description' => 'Premium Kobelco welding consumables and products for professional welding applications',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Kobelco';
    $category_description = 'Premium Kobelco welding consumables and products for professional welding applications';
    ?>
            ...
            <div class="main-product-area">
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Kobelco" data-type="Consumables" data-brand="Kobelco" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
