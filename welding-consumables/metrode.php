...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Metrode',
        'description' => 'Premium Metrode welding consumables and products for professional welding applications',
        'subcategories' => array(
...
<head>
    ...
    <?php 
    $category_name = 'Metrode';
    $category_description = 'Premium Metrode welding consumables and products for professional welding applications';
    ?>
            ...
            <div class="main-product-area">
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="add-to-inquiry" type="button" data-model="Metrode" data-type="Consumables" data-brand="Metrode" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
