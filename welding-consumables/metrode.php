...
if (!$current_category) {
    die("Metrode category not found");
}

$page_title = $current_category['name'] ?? "Metrode";
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Metrode';
    $category_description = $current_category['description'] ?? 'Professional Metrode welding consumables and electrodes.';
    ?>
...
<!-- Mini Sidebar (Icon Bar) -->
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            <h2><?php echo htmlspecialchars($current_category['name'] ?? 'Metrode'); ?></h2>
            ...
            <div class="product-grid">
                <?php 
                // Dynamically fetch products for Metrode subcategory
                $all_products = array();
                ...
                <div class="product-card">
                    <div class="product-image">
                        <i class="bi bi-upc" style="font-size: 60px; color: #ccc;"></i>
                    </div>
                    <h4>Metrode Consumables</h4>
                    <p class="product-type">No products available</p>
                    <button class="add-to-inquiry" type="button" data-model="Metrode" data-type="Welding Consumables" data-brand="Metrode" disabled>ADD TO INQUIRY</button>
                </div>
                    <?php
                }
                ?>
