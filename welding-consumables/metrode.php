...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $subcategory_id,
        'name' => 'Metrode',
        'description' => 'Premium Metrode welding consumables and electrodes.'
    );
}
?>
<!DOCTYPE html>
...
<head>
    ...
    $category_description = $current_category['description'] ?? 'Premium Metrode welding consumables and electrodes.';
    ?>
