...
$page_title = "Metrode Welding Consumables";
$category_id = "welding-consumables";
$subcategory_id = "metrode";
...
if (!$current_category) {
    ...
    $current_category = array(
        'id' => $category_id,
        'name' => 'Metrode',
        'description' => 'Premium Metrode welding consumables including electrodes, wires, and fluxes for industrial applications.',
        'subcategories' => array(
            array('id' => 'metrode', 'name' => 'Metrode')
        )
    );
}
?>
...
<head>
    ...
    <?php 
    $category_name = $current_category['name'] ?? 'Metrode Welding Consumables';
    $category_description = $current_category['description'] ?? 'Premium Metrode welding consumables including electrodes, wires, and fluxes for industrial applications.';
    ?>
    ...
    <div id="miniPopover" class="mini-popover" aria-hidden="true">
        ...
        <div class="category-content">
            ...
            <div class="main-product-area">
                ...
                <?php 
                // Fetch Metrode welding consumable products
                $all_products = andison_get_products_for_subcategory('welding-consumables', 'metrode');
                ...
                if (!empty($all_products)) {
                    foreach ($all_products as $product) {
                        ...
                        $type = htmlspecialchars($product['type'] ?? 'Welding Consumable');
                        $brand = htmlspecialchars($product['brand'] ?? 'Metrode');
                ...
                <div class="product-card">
                    <div class="product-image">
                        <?php if (!empty($image_src)): ?>
                            <img src="<?php echo $image_src; ?>" alt="<?php echo $name; ?>" onerror="this.parentElement.innerHTML='<i class=&quot;bi bi-box&quot; style=&quot;font-size: 56px; color: #ccc;&quot;></i>'">
                        <?php else: ?>
                            <i class="bi bi-box" style="font-size: 56px; color: #ccc;"></i>
                        <?php endif; ?>
                        <?php if (!empty($badge)): ?>
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h4>Metrode Products</h4>
                        <p class="product-description">No products available</p>
                        <button class="add-to-inquiry" type="button" data-model="Metrode" data-type="Welding Consumable" data-brand="Metrode" disabled>ADD TO INQUIRY</button>
                    </div>
                </div>
                <?php
                }
